...
static struct shell_casing_definition shell_casing_definitions[
  NUMBER_OF_SHELL_CASING_TYPES]=
{
  {       // _shell_casing_assault_rifle,
...
struct weapon_definition {
  ...
  int16 ready_ticks, await_reload_ticks, loading_ticks, finish_loading_ticks,
        powerup_ticks;
...
const struct weapon_definition original_weapon_definitions[NUMBER_OF_WEAPONS]=
{
  ...
  /* Fusion Pistol */
  {
    ...
    _weapon_fires_under_media | _weapon_triggers_share_ammo,
    ...
    /* ready/await/load/finish/powerup rounds ticks */
    TICKS_PER_SECOND/3, TICKS_PER_SECOND/2, TICKS_PER_SECOND/2,
...

    {
      ...
      },
      {
        ...
        /* firing, click, charging, shell casing, reload sound */
        _snd_major_fusion_firing, _snd_empty_gun, _snd_fusion_charging, NONE,
        NONE, _snd_major_fusion_charged,
  ...
  /* Assault Rifle */
  {
    ...
    /* ready/await/load/finish/powerup rounds ticks */
    TICKS_PER_SECOND/2, TICKS_PER_SECOND/3, TICKS_PER_SECOND/3,
    ...
    {
      {
        ...
        /* firing, click, charging, shell casing, reload sound */
        _snd_assault_rifle_firing, _snd_empty_gun, NONE,
        _snd_assault_rifle_shell_casings, _snd_assault_rifle_reloading, NONE,
  ...
  /* flamethrower */
  {
    ...
    /* ready/await/load/finish/powerup rounds ticks */
    TICKS_PER_SECOND, (2*TICKS_PER_SECOND)/3, (2*TICKS_PER_SECOND)/3,
    (2*TICKS_PER_SECOND)/3, 0,
  ...
  {
    /* item type, powerup type, item class, item flags */
    _i_alien_shotgun, NONE, _multipurpose_class, _weapon_is_automatic |
    _weapon_disappears_after_use | _weapon_has_random_ammo_on_pickup |
    ...
    {
      {
        ...
        /* firing, click, charging, shell casing, reload sound */
        _snd_smg_firing, _snd_empty_gun, NONE, _snd_assault_rifle_shell_casings,
        _snd_smg_reloading, NONE,
