...
const uint16 player_start_identifier_mask=
  (uint16) ~(_player_start_doesnt_auto_recenter_flag |
             _player_start_doesnt_auto_switch_weapons_flag);
...
void set_player_start_doesnt_auto_recenter_status(player_start_data * const p,
                                                  bool v);
...
void set_player_start_doesnt_auto_switch_weapons_status(
  player_start_data * const p, bool v);
...
inline void set_player_start_doesnt_auto_recenter_status(
  player_start_data * const p, bool v)
{
...
inline bool player_start_doesnt_auto_switch_Weapons(
  const player_start_data * const p)
{
  return TEST_FLAG(p->identifier, _player_start_doesnt_auto_switch_weapons_flag);
}

inline void set_player_start_doesnt_auto_switch_weapons_status(
  player_start_data * const p, bool v)
{
...
#define SET_OBJECT_ANIMATION_FLAGS(o,n) { (o)->flags&= (uint16) ~0x3c00; \
                                          (o)->flags|= (n); }
...
#define SET_OBJECT_INVISIBILITY(o, \
                                v) ((void)((v) ? ((o)->flags|= \
                                                    (uint16)32) : ((o)->flags&= \
                                                                     (uint16) ~32)))
...
#define SET_OBJECT_SOLIDITY(o, \
                            v) ((void)((v) ? ((o)->flags|= \
                                                (uint16)16) : ((o)->flags&= \
                                                                 (uint16) ~16)))

#define GET_OBJECT_STATUS(o) ((o)->flags&(uint16)8)
#define SET_OBJECT_STATUS(o, \
                          v) ((v) ? ((o)->flags|=(uint16)8) : ((o)->flags&= \
                                                                 (uint16) ~8))
#define TOGGLE_OBJECT_STATUS(o) ((o)->flags^=(uint16)8)

#define GET_OBJECT_OWNER(o) ((o)->flags&(uint16)7)
#define SET_OBJECT_OWNER(o, \
                         n) { assert((n)>=0&&(n)<=7); (o)->flags&= (uint16) ~7; \
                              (o)->flags|= (n); }
...
#define SET_ENDPOINT_SOLIDITY(e, \
                              s) ((s) ? ((e)->flags|=1) : ((e)->flags&= \
                                                             ~(uint16)1))

#define ENDPOINT_IS_TRANSPARENT(e) ((e)->flags&4)
#define SET_ENDPOINT_TRANSPARENCY(e, \
                                  s) ((s) ? ((e)->flags|=4) : ((e)->flags&= \
                                                                 ~(uint16)4))

/* false if all polygons sharing this endpoint have the same height */
#define ENDPOINT_IS_ELEVATION(e) ((e)->flags&2)
#define SET_ENDPOINT_ELEVATION(e, \
                               s) ((s) ? ((e)->flags|=2) : ((e)->flags&= \
                                                              ~(uint16)2))
...
#define SET_LINE_SOLIDITY(l, \
                          v) ((v) ? ((l)->flags|= \
                                       (uint16)SOLID_LINE_BIT) : ((l)->flags&= \
                                                                    ( \
                                                                      uint16) ~ \
                                                                    SOLID_LINE_BIT))
#define LINE_IS_SOLID(l) ((l)->flags&SOLID_LINE_BIT)

#define SET_LINE_TRANSPARENCY(l, \
                              v) ((v) ? ((l)->flags|= \
                                           (uint16)TRANSPARENT_LINE_BIT) : ((l) \
                                                                            ->flags&= \
                                                                              ( \
                                                                                uint16) \
                                                                              ~TRANSPARENT_LINE_BIT))
#define LINE_IS_TRANSPARENT(l) ((l)->flags&TRANSPARENT_LINE_BIT)

#define SET_LINE_LANDSCAPE_STATUS(l, \
                                  v) ((v) ? ((l)->flags|= \
                                               (uint16)LANDSCAPE_LINE_BIT) : (( \
                                                                                l)->flags&= \
                                                                                ( \
                                                                                  uint16) \
                                                                                ~LANDSCAPE_LINE_BIT))
...
#define SET_LINE_ELEVATION(l, \
                           v) ((v) ? ((l)->flags|= \
                                        (uint16)ELEVATION_LINE_BIT) : ((l)-> \
                                                                       flags&= \
                                                                         ( \
                                                                           uint16) \
                                                                         ~ELEVATION_LINE_BIT))
...
#define SET_LINE_VARIABLE_ELEVATION(l, \
                                    v) ((v) ? ((l)->flags|= \
                                                 (uint16) \
                                                 VARIABLE_ELEVATION_LINE_BIT) : ((l)->flags&= \
                                                                                   ( \
                                                                                     uint16) \
                                                                                   ~VARIABLE_ELEVATION_LINE_BIT))
#define LINE_IS_VARIABLE_ELEVATION(l) ((l)->flags&VARIABLE_ELEVATION_LINE_BIT)

#define SET_LINE_HAS_TRANSPARENT_SIDE(l, \
                                      v) ((v) ? ((l)->flags|= \
                                                   (uint16) \
                                                   LINE_HAS_TRANSPARENT_SIDE_BIT) : ((l)->flags&= \
                                                                                       ( \
                                                                                         uint16) \
                                                                                       ~LINE_HAS_TRANSPARENT_SIDE_BIT))
...
#define SET_SIDE_CONTROL_PANEL(s, \
                               t) ((void)((t) ? (s->flags |= \
                                                   (uint16) \
                                                   _side_is_control_panel) : (s->flags &= \
                                                                                ( \
                                                                                  uint16) \
                                                                                ~_side_is_control_panel)))

#define GET_CONTROL_PANEL_STATUS(s) (((s)->flags & _control_panel_status) != 0)
#define SET_CONTROL_PANEL_STATUS(s, \
                                 t) ((t) ? (s->flags |= \
                                              (uint16) _control_panel_status) : ( \
                                                s->flags &= \
                                                  ( \
                                                    uint16) \
                                                  ~_control_panel_status))
...
#define SET_SIDE_IS_REPAIR_SWITCH(s, \
                                  t) ((t) ? (s->flags |= \
                                               (uint16) _side_is_repair_switch) \
                                               : (s->flags &= \
                                                    ( \
                                                      uint16) \
...
#define SET_SIDE_IS_DIRTY(s, \
                          t) ((t) ? (s->flags|= \
                                       (uint16)_editor_dirty_bit) : (s->flags&= \
                                                                       ( \
                                                                         uint16) \
                                                                       ~_editor_dirty_bit))
...
#define SET_POLYGON_DETACHED_STATE(p, \
                                   v) ((v) ? ((p)->flags|= \
                                                POLYGON_IS_DETACHED_BIT) : ((p) \
                                                                            ->flags&= \
                                                                              ~ \
                                                                              POLYGON_IS_DETACHED_BIT))
...
struct saved_static_light_data /* 8*2 + 6*14 == 100 bytes */
{
  ...
  struct saved_lighting_function_specification primary_active, secondary_active,
                                               becoming_active;
  struct saved_lighting_function_specification primary_inactive,
                                               secondary_inactive,
                                               becoming_inactive;
...
#define LINE_IS_IN_AUTOMAP(i) ((automap_lines[(i)>> \
                                              3]& \
                                ((byte)1<<((i)&0x07))) ? (true) : (false))

#define ADD_POLYGON_TO_AUTOMAP(i) (automap_polygons[(i)>> \
                                                    3] |= (byte) 1<<((i)&0x07))
#define POLYGON_IS_IN_AUTOMAP(i) ((automap_polygons[(i)>> \
                                                    3]& \
                                   ((byte)1<<((i)&0x07))) ? (true) : (false))
...
void changed_polygon(short original_polygon_index, short new_polygon_index,
                     short player_index);
...
short new_map_object2d(world_point2d *location, short polygon_index,
                       shape_descriptor shape,
                       angle facing);
short new_map_object3d(world_point3d *location, short polygon_index,
                       shape_descriptor shape,
                       angle facing);
short new_map_object(struct object_location *location, shape_descriptor shape);
short attach_parasitic_object(short host_index, shape_descriptor shape,
                              angle facing);
void remove_parasitic_object(short host_index);
bool translate_map_object(short object_index, world_point3d *new_location,
                          short new_polygon_index);
short find_new_object_polygon(world_point2d *parent_location,
...
extern void deferred_add_object_to_polygon_object_list(short object_index,
...
void get_object_shape_and_transfer_mode(world_point3d *camera_location,
                                        short object_index,
                                        struct shape_and_transfer_mode *data);
void set_object_shape_and_transfer_mode(short object_index,
                                        shape_descriptor shape,
                                        short transfer_mode);
...
void play_world_sound(short polygon_index, world_point3d *origin,
                      short sound_code);

#define play_side_sound(side_index, sound_code) _play_side_sound(side_index, \
                                                                 sound_code, \
                                                                 FIXED_ONE)
...
short clockwise_endpoint_in_line(short polygon_index, short line_index,
                                 short index);
...
short find_line_crossed_leaving_polygon(short polygon_index, world_point2d *p0,
                                        world_point2d *p1);
...
int32 point_to_line_segment_distance_squared(world_point2d *p, world_point2d *a,
                                             world_point2d *b);
int32 point_to_line_distance_squared(world_point2d *p, world_point2d *a,
                                     world_point2d *b);

_fixed closest_point_on_line(world_point2d *e0, world_point2d *e1,
                             world_point2d *p,
                             world_point2d *closest_point);
void closest_point_on_circle(world_point2d *c, world_distance radius,
                             world_point2d *p,
                             world_point2d *closest_point);

_fixed find_line_intersection(world_point2d *e0, world_point2d *e1,
                              world_point3d *p0,
                              world_point3d *p1,
                              world_point3d *intersection);
_fixed find_floor_or_ceiling_intersection(world_distance h, world_point3d *p0,
                                          world_point3d *p1,
                                          world_point3d *intersection);

void ray_to_line_segment(world_point2d *p0, world_point2d *p1, angle theta,
                         world_distance d);

void push_out_line(world_point2d *e0, world_point2d *e1, world_distance d,
                   world_distance line_length);
bool keep_line_segment_out_of_walls(short polygon_index, world_point3d *p0,
                                    world_point3d *p1,
                                    world_distance maximum_delta_height,
                                    world_distance height,
...
bool line_is_obstructed(short polygon_index1, world_point2d *p1,
                        short polygon_index2,
                        world_point2d *p2);
bool point_is_player_visible(short max_players, short polygon_index,
                             world_point2d *p,
                             int32 *distance);
bool point_is_monster_visible(short polygon_index, world_point2d *p,
                              int32 *distance);
...
void random_point_on_circle(world_point3d *center, short center_polygon_index,
                            world_distance radius, world_point3d *random_point,
...
short new_map_line(short a, short b, short poly_a, short poly_b, short side_a,
                   short side_b);
...
short new_map_polygon(short *line_indexes, short line_count, short floor_height,
                      short ceiling_height, short floor_texture,
...
void calculate_endpoint_polygon_owners(short endpoint_index, short *first_index,
                                       short *index_count);
void calculate_endpoint_line_owners(short endpoint_index, short *first_index,
                                    short *index_count);
...
uint8 *unpack_map_annotation(uint8 *Stream, map_annotation* Objects,
                             size_t Count);
...
uint8 *unpack_object_frequency_definition(uint8 *Stream,
                                          object_frequency_definition* Objects,
                                          size_t Count);
uint8 *pack_object_frequency_definition(uint8 *Stream,
                                        object_frequency_definition* Objects,
                                        size_t Count);
...
uint8 *unpack_ambient_sound_image_data(uint8 *Stream,
                                       ambient_sound_image_data* Objects,
                                       size_t Count);
uint8 *pack_ambient_sound_image_data(uint8 *Stream,
                                     ambient_sound_image_data* Objects,
                                     size_t Count);
uint8 *unpack_random_sound_image_data(uint8 *Stream,
                                      random_sound_image_data* Objects,
                                      size_t Count);
uint8 *pack_random_sound_image_data(uint8 *Stream,
                                    random_sound_image_data* Objects,
                                    size_t Count);
...
uint8 *unpack_damage_definition(uint8 *Stream, damage_definition* Objects,
                                size_t Count);
uint8 *pack_damage_definition(uint8 *Stream, damage_definition* Objects,
                              size_t Count);
...
short get_random_player_starting_location_and_facing(
  short max_player_index, short team, struct object_location *location);
...
bool control_panel_in_environment(short control_panel_type,
...
void assume_correct_switch_position(short switch_type, short permutation,
                                    bool new_state);

void try_and_toggle_control_panel(short polygon_index, short line_index);

bool line_side_has_control_panel(short line_index, short polygon_index,
...
bool get_indexed_entry_point(struct entry_point *entry_point, short *index,
                             int32 type);
