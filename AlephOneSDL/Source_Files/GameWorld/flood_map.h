...
typedef int32 (*cost_proc_ptr)(short source_polygon_index, short line_index,
...
short new_path(world_point2d *source_point, short source_polygon_index,
               ...
               short destination_polygon_index,
               world_distance minimum_separation, cost_proc_ptr cost,
               void *data);
...
short flood_map(short first_polygon_index, int32 maximum_cost,
                cost_proc_ptr cost_proc, short flood_mode,
                void *caller_data);
