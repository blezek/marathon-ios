...
struct platform_definition platform_definitions[NUMBER_OF_PLATFORM_TYPES]=
{
  {       // _platform_is_spht_door
    ...
    {             /* defaults */
      _platform_is_spht_door, _fast_platform, _very_long_delay_platform, NONE,
      NONE,
      FLAG(_platform_deactivates_at_initial_level) | FLAG(
        _platform_extends_floor_to_ceiling) |
      FLAG(_platform_is_player_controllable) | FLAG(
        _platform_is_monster_controllable) |
      FLAG(_platform_reverses_direction_when_obstructed) | FLAG(
  ...
  {       // _platform_is_split_spht_door
    ...
    {             /* defaults */
      _platform_is_spht_split_door, _slow_platform, _very_long_delay_platform,
      NONE, NONE,
      FLAG(_platform_deactivates_at_initial_level) | FLAG(
        _platform_extends_floor_to_ceiling) |
      FLAG(_platform_is_player_controllable) | FLAG(
      ...
      FLAG(_platform_is_initially_extended) |
  ...
  {       // _platform_is_locked_spht_door
    ...
    {             /* defaults */
      _platform_is_locked_spht_door, _slow_platform, _very_long_delay_platform,
      NONE, NONE,
      FLAG(_platform_deactivates_at_initial_level) | FLAG(
        _platform_extends_floor_to_ceiling) |
      FLAG(_platform_is_player_controllable) | FLAG(
  ...
  {       // _platform_is_spht_platform
    ...
    {             /* defaults */
      _platform_is_spht_platform, _slow_platform, _long_delay_platform, NONE,
      NONE,
      FLAG(_platform_is_initially_active) | FLAG(
        _platform_is_initially_extended) | FLAG(_platform_comes_from_floor) |
  ...
  {       // _platform_is_noisy_spht_platform
    ...
    {             /* defaults */
      _platform_is_noisy_spht_platform, _slow_platform, _long_delay_platform,
      NONE, NONE,
      FLAG(_platform_is_initially_active) | FLAG(
        _platform_is_initially_extended) | FLAG(_platform_comes_from_floor) |
      FLAG(_platform_reverses_direction_when_obstructed)
  ...
  {       // _platform_is_heavy_spht_door
    ...
    {             /* defaults */
      _platform_is_heavy_spht_door, _slow_platform, _very_long_delay_platform,
      NONE, NONE,
      FLAG(_platform_deactivates_at_initial_level) | FLAG(
        _platform_extends_floor_to_ceiling) |
      FLAG(_platform_is_player_controllable) | FLAG(
  ...
  {       // pfhor door
    ...
    {             /* defaults */
      _platform_is_pfhor_door, _fast_platform, _very_long_delay_platform, NONE,
      NONE,
      FLAG(_platform_deactivates_at_initial_level) | FLAG(
        _platform_extends_floor_to_ceiling) |
      FLAG(_platform_is_player_controllable) | FLAG(
  ...
  {       // _platform_is_heavy_spht_platform
    ...
    {             /* defaults */
      _platform_is_heavy_spht_platform, _slow_platform, _long_delay_platform,
      NONE, NONE,
      FLAG(_platform_is_initially_active) | FLAG(
        _platform_is_initially_extended) |
      FLAG(_platform_comes_from_floor) | FLAG(
  ...
  {       // pfhor platform
    ...
    {             /* defaults */
      _platform_is_pfhor_platform, _slow_platform, _long_delay_platform, NONE,
      NONE,
      FLAG(_platform_is_initially_active) | FLAG(
        _platform_is_initially_extended) | FLAG(_platform_comes_from_floor) |
      FLAG(_platform_reverses_direction_when_obstructed)
