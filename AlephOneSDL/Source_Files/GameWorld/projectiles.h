...
#define MAXIMUM_PROJECTILES_PER_MAP (get_dynamic_limit( \
...
#define SET_PROJECTILE_FLYBY_STATUS(p, \
                                    v) ((void)((v) ? ((p)->flags|= \
                                                        (uint16)0x4000) : ((p) \
                                                                           ->flags&=(uint16) ~0x4000)))
...
#define SET_PROJECTILE_DAMAGE_STATUS(p, \
                                     v) ((void)((v) ? ((p)->flags|= \
                                                         (uint16)0x2000) : ((p) \
                                                                            ->flags&=(uint16) ~0x2000)))
...
bool preflight_projectile(world_point3d *origin, short polygon_index,
                          world_point3d *_vector,
                          angle delta_theta, short type, short owner,
                          short owner_type,
                          short *target_index);
short new_projectile(world_point3d *origin, short polygon_index,
                     world_point3d *_vector,
                     angle delta_theta, short type, short owner_index,
                     short owner_type, short intended_target_index,
                     _fixed damage_scale);
...
uint16 translate_projectile(short type, world_point3d *old_location,
                            short old_polygon_index,
                            world_point3d *new_location,
                            short *new_polygon_index,
                            short owner_index, short *obstruction_index,
...
void drop_the_ball(world_point3d *origin, short polygon_index,
                   short owner_index,
                   short owner_type,
                   short item_type);
