...
static struct projectile_definition projectile_definitions[
  NUMBER_OF_PROJECTILE_TYPES];
const struct projectile_definition original_projectile_definitions[
  NUMBER_OF_PROJECTILE_TYPES]=
{
  {             /* player’s rocket */
  ...
  {             /* player’s shotgun bullet */
    ...
    _bleeding_projectile|_can_toggle_control_panels|
  ...
  {             /* _projectile_fist */
    ...
    _usually_pass_transparent_side|_can_toggle_control_panels|
  ...
  {       /* _projectile_juggernaut_missile */
    ...
    _affected_by_half_gravity|_can_toggle_control_panels|_guided|
    _positive_vertical_error,                                                                          /* flags */
  ...
  {             /* _projectile_hummer_durandal */
    ...
    _small_media_detonation_effect,                                                            /* detonation effect, media_detonation_effect */
    NONE, 0, NONE,             /* contrail effect, ticks between contrails, maximum contrails */
    NONE,             /* media projectile promotion */
  ...
  {             /* _projectile_minor_cyborg_ball */
    ...
    _can_toggle_control_panels|_sometimes_pass_transparent_side|
    _alien_projectile|_rebounds_from_floor|_doubly_affected_by_gravity,                                                                         /* flags */
  ...
  {             /* _projectile_major_cyborg_ball */
    ...
    _guided|_can_toggle_control_panels|_sometimes_pass_transparent_side|
    _alien_projectile|_rebounds_from_floor|_doubly_affected_by_gravity,                                                                                 /* flags */
  ...
  {             /* _projectile_ball */
    ...
    _persistent_and_virulent|_penetrates_media|_becomes_item_on_detonation|
    _can_toggle_control_panels|_rebounds_from_floor|
  ...
  {             /* player’s smg bullet */
    ...
    _bleeding_projectile|_usually_pass_transparent_side|
    _penetrates_media_boundary,                                                                 /* flags */
