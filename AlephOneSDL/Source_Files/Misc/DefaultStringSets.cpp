...
public:
AutoStringSetBuilder(short inStringSetID, const char** inStrings,
                     short inNumStrings) {
...
#define BUILD_STRINGSET(id, strs)   static AutoStringSetBuilder ( \
    strs ## Builder) (id, strs, NUMBER_OF_STRINGS(strs))
