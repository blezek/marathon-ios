...
#define NUMBER_OF_STANDARD_KEY_DEFINITIONS (sizeof(standard_key_definitions)/ \
...
#define NUMBER_OF_LEFT_HANDED_KEY_DEFINITIONS (sizeof( \
...
#define NUMBER_OF_POWERBOOK_KEY_DEFINITIONS (sizeof(powerbook_key_definitions)/ \
                                             sizeof(struct key_definition))
...
extern struct key_definition current_key_definitions[
