...
// Sets V2 = V0 + V1
template <class T0, class T1, class T2> inline void VecAdd(const T0* V0,
                                                           const T1* V1,
                                                           T2* V2)
{
  V2[0] = T2(V0[0] + V1[0]);
...
// Sets V2 = V0 - V1
template <class T0, class T1, class T2> inline void VecSub(const T0* V0,
                                                           const T1* V1,
                                                           T2* V2)
{
  V2[0] = T2(V0[0] - V1[0]);
...
// Sets V1 = V0 * S
template <class T0, class TS, class T1> inline void VecScalarMult(const T0* V0,
                                                                  const TS& S,
                                                                  T1* V1)
{
  V1[0] = T1(S*V0[0]);
...
// Sets V2 = V0 x V1
template <class T0, class T1, class T2> inline void VectorProd(const T0* V0,
                                                               const T1* V1,
                                                               T2* V2)
{
