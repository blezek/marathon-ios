...
OSErr NetRegisterName(unsigned char *name, unsigned char *type, short version,
                      short socketNumber);
...
OSErr NetLookupOpen(unsigned char *name, unsigned char *type,
                    unsigned char *zone, short version,
...
OSErr NetGetZoneList(Str32 *zone_names, short maximum_zone_names,
                     short *zone_count,
                     short *local_zone);
...
OSErr NetDDPSendFrame(DDPFramePtr frame, AddrBlock *address, short protocolType,
                      short socket);
