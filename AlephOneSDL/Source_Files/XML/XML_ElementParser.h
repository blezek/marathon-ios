...
size_t DeUTF8_Pas(const char *InString, size_t InLen, Str255 OutString,
                  size_t OutMaxLen);
...
template<class T> bool ReadNumericalValue(const char *String,
                                          const char *Format,
                                          T& Value)
{
...
template<class T> bool ReadBoundedNumericalValue(const char *String,
                                                 const char *Format,
                                                 T& Value, const T& MinVal,
                                                 const T& MaxVal)
{
...
bool ReadBoundedInt16Value(const char *String, int16& Value, int16 MinVal,
                           int16 MaxVal);
bool ReadUInt16Value(const char *String, uint16& Value);
bool ReadBoundedUInt16Value(const char *String, uint16& Value, uint16 MinVal,
                            uint16 MaxVal);

bool ReadInt32Value(const char *String, int32& Value);
bool ReadBoundedInt32Value(const char *String, int32& Value, int32 MinVal,
                           int32 MaxVal);
bool ReadUInt32Value(const char *String, uint32& Value);
bool ReadBoundedUInt32Value(const char *String, uint32& Value, uint32 MinVal,
                            uint32 MaxVal);
...
virtual bool HandleString(const char * /*String*/, int /*Length*/) {
  return true;
}
