...
bool XML_ElementParser::ReadBoundedInt16Value(const char *String, int16& Value,
                                              int16 MinVal,
                                              int16 MaxVal)
{
...
bool XML_ElementParser::ReadBoundedUInt16Value(const char *String,
                                               uint16& Value, uint16 MinVal,
                                               uint16 MaxVal)
{
...
bool XML_ElementParser::ReadBoundedInt32Value(const char *String, int32& Value,
                                              int32 MinVal,
                                              int32 MaxVal)
{
...
bool XML_ElementParser::ReadBoundedUInt32Value(const char *String,
                                               uint32& Value, uint32 MinVal,
                                               uint32 MaxVal)
{
...
bool XML_ElementParser::ReadBooleanValueAsInt16(const char *String,
                                                int16& Value)
{
  return ReadBooleanValue(String,Value);
}

bool XML_ElementParser::ReadBooleanValueAsUInt16(const char *String,
                                                 uint16& Value)
{
  return ReadBooleanValue(String,Value);
}

bool XML_ElementParser::ReadBooleanValueAsInt32(const char *String,
                                                int32& Value)
{
  return ReadBooleanValue(String,Value);
}

bool XML_ElementParser::ReadBooleanValueAsUInt32(const char *String,
                                                 uint32& Value)
{
  return ReadBooleanValue(String,Value);
}
...
void XML_ElementParser::AddChild(XML_ElementParser *Child)
{
  ...
  for (unsigned k=0; k<Children.size(); k++)
    if (Children[k]->NameMatch(ChildName)) {
      return;
    }
...
void XML_ElementParser::UnrecognizedTag() {
  ErrorString = UnrecognizedTagString;
}
void XML_ElementParser::AttribsMissing() {
  ErrorString = AttribsMissingString;
}
void XML_ElementParser::BadNumericalValue() {
  ErrorString = BadNumericalValueString;
}
void XML_ElementParser::OutOfRange() {
  ErrorString = OutOfRangeString;
}
void XML_ElementParser::BadBooleanValue() {
  ErrorString = BadBooleanValueString;
}
...
size_t DeUTF8(const char *InString, size_t InLen, char *OutString,
              size_t OutMaxLen)
{
...
//			uint8 oc = (uc >= 0x20 && uc != 0x7f && uc <= 0xff) ? uint8(uc) : '$';
      uint8 oc =
        (uc >= 0x20 && uc != 0x7f && uc < 0x10000) ? unicode_to_mac_roman(
          (uint16) uc) : '$';
...
size_t DeUTF8_Pas(const char *InString, size_t InLen, unsigned char *OutString,
                  size_t OutMaxLen)
{
  size_t Len = DeUTF8(InString,InLen,reinterpret_cast<char*>(OutString+1),
                      OutMaxLen);
  assert(Len < 256);
...
size_t DeUTF8_C(const char *InString, size_t InLen, char *OutString,
                size_t OutMaxLen)
{
