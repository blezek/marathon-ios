...
virtual void render_node_object(render_object_data *object,
...
TextureManager setupWallTexture(const shape_descriptor& Texture,
                                short transferMode, float wobble,
                                float intensity, float offset,
                                RenderStep renderStep);
TextureManager setupSpriteTexture(const rectangle_definition& rect, short type,
                                  float offset,
                                  RenderStep renderStep);
};
