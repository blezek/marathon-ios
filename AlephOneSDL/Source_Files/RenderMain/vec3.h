...
struct vec3 : public vec4 {
  ...
  vec3(const GLfloat& x, const GLfloat& y, const GLfloat& z) : vec4(x, y, z,
                                                                    0.0) {
  }
  ...
  bool operator == (const vec3& v) const {
    // DJB
    return (fabs(_d[0] - v[0]) + fabs(_d[1] - v[1]) + fabs(_d[2] - v[2])) <
           kThreshhold;
  }
...
struct vertex3 : public vec4 {
  ...
  vertex3(const GLfloat& x, const GLfloat& y, const GLfloat& z) : vec4(x, y, z,
                                                                       1.0) {
  }
