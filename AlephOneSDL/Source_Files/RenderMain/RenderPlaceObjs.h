...
short build_base_node_list(short origin_polygon_index,
                           world_point3d *origin, world_distance left_distance,
...
void build_aggregate_render_object_clipping_window(
  ...
  sorted_node_data **
  base_nodes, short base_node_count);

shape_information_data *rescale_shape_information(
  shape_information_data *unscaled,
  shape_information_data *
  scaled, uint16 flags);
