...
extern short number_of_shading_tables, shading_table_fractional_bits,
             shading_table_size;
...
#define COMPLETE_SHADING_TABLE_SIZE (SHADING_TABLE_SIZE* \
                                     NUMBER_OF_SHADING_TABLES)
...
// Ir addition:
#define HORIZONTAL_HEIGHT_COORD_DOWNSHIFT (HORIZONTAL_HEIGHT_DOWNSHIFT- \
                                           HORIZONTAL_WIDTH_SHIFT)
#define HORIZONTAL_HEIGHT_COORD_MASK (((1<< \
                                        HORIZONTAL_HEIGHT_SHIFT)- \
                                       1)<<HORIZONTAL_WIDTH_SHIFT)
...
#define BIG_HORIZONTAL_HEIGHT_COORD_DOWNSHIFT (BIG_HORIZONTAL_HEIGHT_DOWNSHIFT- \
                                               BIG_HORIZONTAL_WIDTH_SHIFT)
#define BIG_HORIZONTAL_HEIGHT_COORD_MASK (((1<< \
                                            BIG_HORIZONTAL_HEIGHT_SHIFT)- \
                                           1)<<BIG_HORIZONTAL_WIDTH_SHIFT)
...
#define BIG_VERTICAL_TEXTURE_WIDTH_FRACTIONAL_BITS (FIXED_FRACTIONAL_BITS- \
                                                    BIG_VERTICAL_TEXTURE_WIDTH_BITS)
...
void _big_transparent_texture_horizontal_polygon_lines8(
  HORIZONTAL_TEXTURE_PARAMS);
void _big_transparent_texture_horizontal_polygon_lines16(
  HORIZONTAL_TEXTURE_PARAMS);
void _big_transparent_texture_horizontal_polygon_lines32(
  HORIZONTAL_TEXTURE_PARAMS);
...
void _big_translucent_texture_horizontal_polygon_lines16(
  HORIZONTAL_TEXTURE_PARAMS);
void _big_translucent_texture_horizontal_polygon_lines32(
  HORIZONTAL_TEXTURE_PARAMS);
void _big_transpucent_texture_horizontal_polygon_lines16(
  HORIZONTAL_TEXTURE_PARAMS);
void _big_transpucent_texture_horizontal_polygon_lines32(
  HORIZONTAL_TEXTURE_PARAMS);
