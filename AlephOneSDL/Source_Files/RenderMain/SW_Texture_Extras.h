...
{
public:
SW_Texture() : m_opac_type(0), m_shape_descriptor(0), m_opac_scale(1.0),
  m_opac_shift(0.0) {
}
void descriptor(shape_descriptor ShapeDesc) {
  m_shape_descriptor = ShapeDesc;
}
int opac_type() {
  return m_opac_type;
}
void opac_type(int new_opac_type) {
  m_opac_type = new_opac_type;
}
...
void opac_shift(float new_opac_shift) {
  m_opac_shift = new_opac_shift;
}
void opac_scale(float new_opac_scale) {
  m_opac_scale = new_opac_scale;
}
