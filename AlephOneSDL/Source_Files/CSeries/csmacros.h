...
#define SET_FLAG32(flags,bit, \
                   value) ((value) ? ((flags)|=FLAG(bit)) : ((flags)&=~FLAG(bit)))

#define FLAG16(bit) (1<<(bit))
#define TEST_FLAG16(flags,bit) (((flags)&FLAG16(bit))!=0)
#define SET_FLAG16(flags,bit, \
                   value) ((void)((value) ? ((flags)|=FLAG16(bit)) : ((flags)&= \
                                                                        ~FLAG16( \
                                                                          bit))))

// LP addition (Mar 2, 2000): some more generic routines for flags
#define TEST_FLAG(obj,flag) ((obj)&(flag))
#define SET_FLAG(obj,flag, \
                 value) ((void)((value) ? ((obj)|=(flag)) : ((obj)&=~(flag))))
...
template<class T> T* GetMemberWithBounds(T* Array, const size_t Index,
                                         const size_t Number)
{
  // Bounds checking
...
template<class T> void objlist_copy(T* destination, const T* source,
                                    size_t num_objects)
{
...
template<class T> void objlist_set(T* object_list, int value,
                                   size_t num_objects)
{
