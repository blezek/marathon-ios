...
extract_number_from_text_item(
  ...
  w_number_entry*     theWidget =
    dynamic_cast<w_number_entry*>(dlg->get_widget_by_id(item));
...
get_selection_control_value(DialogPtr dialog, short which_control)
{
  ...
  w_select*   theSelectionWidget =
    dynamic_cast<w_select*>(dialog->get_widget_by_id(which_control));
...
get_boolean_control_value(DialogPtr dialog, short which_control)
{
  ...
  w_toggle*   theSelectionWidget =
    dynamic_cast<w_toggle*>(dialog->get_widget_by_id(which_control));
...
copy_pstring_from_text_field(DialogPtr dialog, short item,
  ...
  w_text_entry*       theTextField =
    dynamic_cast<w_text_entry*>(dialog->get_widget_by_id(item));
...
copy_pstring_to_static_text(DialogPtr dialog, short item,
  ...
  w_static_text*      theStaticText =
    dynamic_cast<w_static_text*>(dialog->get_widget_by_id(item));
...
int QQ_get_selector_control_value (DialogPTR dlg, int item)
{
  ...
  w_select_popup* theWidget2 =
    dynamic_cast<w_select_popup*>(dlg->get_widget_by_id(item));
  if (theWidget2 != NULL) {
...
const std::string QQ_copy_string_from_text_control (DialogPTR dlg, int item)
{
  ...
  w_text_entry* theTextEntryWidget =
    dynamic_cast<w_text_entry*>(dlg->get_widget_by_id(item));
