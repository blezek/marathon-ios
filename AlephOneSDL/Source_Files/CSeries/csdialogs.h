...
extern void QQ_set_selector_control_labels (
  DialogPTR dlg, int item, const std::vector<std::string> labels);
extern void QQ_set_selector_control_labels_from_stringset (DialogPTR dlg,
                                                           int item,
                                                           int stringset_id);

extern const std::string QQ_copy_string_from_text_control (DialogPTR dlg,
                                                           int item);
extern void QQ_copy_string_to_text_control (DialogPTR dlg, int item,
                                            const std::string &s);
...
extern void copy_pstring_to_static_text(DialogPtr dialog, short item,
                                        const unsigned char* pstring);
...
__inline__ void modify_selection_control(
  ...
  short hilite,
  short value) {
  modify_control(dlg, item, hilite, value);
}
...
__inline__ void modify_control_enabled(
  ...
  short item,
  short hilite) {
  modify_control(dlg, item, hilite, NONE);
}
...
__inline__ short get_selection_control_value(
  DialogPtr dialog,
  short which_control) {
  return get_dialog_control_value(dialog, which_control);
}
