...
typedef void (*NetDistributionProc)(void *buffer, short buffer_size,
                                    short player_index);
...
bool NetGameJoin(void *player_data, short player_data_size,
                 const char* host_address_string);
...
bool NetGetMostRecentChatMessage(player_info** outSendingPlayerData,
                                 char** outMessage);
...
OSErr NetDistributeGameDataToAllPlayers(byte* wad_buffer, int32 wad_length,
                                        bool do_physics);
...
// sub-range.
void NetAddDistributionFunction(int16 type, NetDistributionProc proc,
                                bool lossy);
void NetDistributeInformation(short type, void *buffer, short buffer_size,
                              bool send_to_self,
