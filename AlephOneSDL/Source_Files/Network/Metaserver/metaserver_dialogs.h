...
class GlobalMetaserverChatNotificationAdapter : public MetaserverClient::
  NotificationAdapter
{
public:
virtual void playersInRoomChanged(const std::vector<MetaserverPlayerInfo>&);
virtual void gamesInRoomChanged(
  const std::vector<GameListMessage::GameListEntry>&);
...
void gamesInRoomChanged(
  const std::vector<GameListMessage::GameListEntry> &gamesChanges);
void sendChat();
