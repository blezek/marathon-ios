...
typedef WritableTickBasedCircularQueue<action_flags_t>
WritableTickBasedActionQueue;


class XML_ElementParser;

extern void hub_initialize(int32 inStartingTick, size_t inNumPlayers,
...
extern void spoke_initialize(
  const NetAddrBlock &inHubAddress, int32 inFirstTick, size_t inNumberOfPlayers,
  WritableTickBasedActionQueue* const inPlayerQueues[],
  bool inPlayerConnectedStatus[], size_t inLocalPlayerIndex, bool inHubIsLocal);
...
extern void spoke_distribute_lossy_streaming_bytes_to_everyone(
  int16 inDistributionType, byte* inBytes, uint16 inLength,
...
extern void spoke_distribute_lossy_streaming_bytes(int16 inDistributionType,
