...
static CircularQueue<NetworkSpeakerSoundBufferDescriptor>    sSoundBuffers(
  kSoundBufferQueueSize);

// "Return queue" of buffers from audio code to us for reuse
static CircularQueue<byte*>                            sSoundDataBuffers(
  kNumSoundDataBuffers + 2);                                                                          // +2: breathing room
