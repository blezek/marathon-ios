...
class GatherDialog : public GatherCallbacks, public ChatCallbacks,
  public GlobalMetaserverChatNotificationAdapter
{
public:
...
class JoinDialog : public GlobalMetaserverChatNotificationAdapter,
...
bool network_game_setup(player_info *player_information,
                        game_info *game_information, bool inResumingGame,
...
extern void update_carnage_summary(NetgameOutcomeData &outcome,
                                   struct net_rank *ranks,
                                   short num_players, short suicide_index,
                                   bool do_totals,
                                   bool friendly_fire);

// Routines
extern void menu_index_to_level_entry(short index, int32 entry_flags,
...
extern void draw_kill_bars(NetgameOutcomeData &outcome, struct net_rank *ranks,
                           short num_players,
                           short suicide_index, bool do_totals,
                           bool friendly_fire);
extern void draw_score_bars(NetgameOutcomeData &outcome, struct net_rank *ranks,
                            short bar_count);
