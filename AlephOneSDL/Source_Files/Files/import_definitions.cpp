  ...
  if(open_wad_file_for_reading(PhysicsFileSpec,PhysicsFile)) {
    ...
    if(read_wad_header(PhysicsFile, &header)) {
      if(header.data_version==BUNGIE_PHYSICS_DATA_VERSION ||
         header.data_version==PHYSICS_DATA_VERSION) {
  ...
  struct wad_data *wad)
{
  ...
  data= (unsigned char *)extract_type_from_wad(wad, MONSTER_PHYSICS_TAG,
                                               &data_length);
  ...
  data= (unsigned char *)extract_type_from_wad(wad, EFFECTS_PHYSICS_TAG,
                                               &data_length);
  ...
  data= (unsigned char *)extract_type_from_wad(wad, PROJECTILE_PHYSICS_TAG,
                                               &data_length);
  ...
  data= (unsigned char*) extract_type_from_wad(wad, WEAPONS_PHYSICS_TAG,
                                               &data_length);
