  ...
  void *data)
{
  ...
  struct find_files_private_data *_private=
    (struct find_files_private_data *) data;
...
{
  bool add_this_file= false;
  struct find_checksum_private_data *_private=
    (struct find_checksum_private_data *) data;
