...
{
  // Global actions
  { "\pFire Primary",     Icon_FirePrimary,               0,
    kISpElementKind_Button,              kISpElementLabel_Btn_Fire,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pFire Secondary",   Icon_FireSecondary,             0,
    kISpElementKind_Button,              kISpElementLabel_Btn_SecondaryFire,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pMove Forward",             Icon_MoveForward,               0,
    kISpElementKind_Button,              kISpElementLabel_Btn_MoveForward,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pMove Backward",    Icon_MoveBackward,              0,
    kISpElementKind_Button,              kISpElementLabel_Btn_MoveBackward,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pLook Left",                Icon_TurnLeft,                  0,
    kISpElementKind_Button,              kISpElementLabel_Btn_TurnLeft,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pLook Right",               Icon_TurnRight,                 0,
    kISpElementKind_Button,              kISpElementLabel_Btn_TurnRight,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pSidestep Left",    Icon_MoveLeft,                  0,
    kISpElementKind_Button,              kISpElementLabel_Btn_SlideLeft,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pSidestep Right",   Icon_MoveRight,                 0,
    kISpElementKind_Button,              kISpElementLabel_Btn_SlideRight,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pGlance Left",              Icon_LookLeft,                  0,
    kISpElementKind_Button,              kISpElementLabel_Btn_LookLeft,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pGlance Right",     Icon_LookRight,                 0,
    kISpElementKind_Button,              kISpElementLabel_Btn_LookRight,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pLook Up",                  Icon_LookUp,                    0,
    kISpElementKind_Button,              kISpElementLabel_Btn_LookUp,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pLook Down",                Icon_LookDown,                  0,
    kISpElementKind_Button,              kISpElementLabel_Btn_LookDown,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pLook Ahead",               Icon_LookForward,               0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pPrevious Weapon",  Icon_PrevWeapon,                0,
    kISpElementKind_Button,              kISpElementLabel_Btn_Previous,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pNext Weapon",              Icon_NextWeapon,                0,
    kISpElementKind_Button,              kISpElementLabel_Btn_Next,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pAction",                   Icon_Action,                    0,
    kISpElementKind_Button,              kISpElementLabel_Btn_Select,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pRun/Walk Toggle",  Icon_RunNotWalk,                0,
    kISpElementKind_Button,              kISpElementLabel_Btn_Run,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pMove Sideways",    Icon_SideNotTurn,               0,
    kISpElementKind_Button,              kISpElementLabel_Btn_SideStep,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pLook Sideways",    Icon_LookNotTurn,               0,
    kISpElementKind_Button,              kISpElementLabel_Btn_Look,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pAuto Map",                 Icon_AutoMap,                   0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pMicrophone",               Icon_Microphone,                0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},

  // Local actions
  { "\pQuit",                             Icon_Quit,
    0, kISpElementKind_Button,              kISpElementLabel_Btn_Quit,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pPause",                    Icon_Pause,                     0,
    kISpElementKind_Button,              kISpElementLabel_Btn_StartPause,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pSound Down",               Icon_SoundDown,                 0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pSound Up",                 Icon_SoundUp,                   0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pMap Outward",              Icon_MapOut,                    0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pMap Inward",               Icon_MapIn,                     0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pInventory Prev",   Icon_InvenPrev,                 0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pInventory Next",   Icon_InvenNext,                 0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pSwitch Player",    Icon_SwitchPlayer,              0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pBackground Tasks", Icon_BkgdTasks,                 0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pFrames Per Sec",   Icon_FramesPerSec,              0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pPixel Resolution", Icon_PixelRes,                  0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pScreen Res Down",  Icon_ScreenDown,                0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pScreen Res Up",    Icon_ScreenUp,                  0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pBrightness Down",  Icon_BrightDown,                0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pBrightness Up",    Icon_BrightUp,                  0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pSwitch Sides",             Icon_SwitchSides,               0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pChase Cam",                Icon_ChaseCam,                  0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pTunnel Vision",    Icon_TunnelVision,              0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pCrosshairs",               Icon_Crosshairs,                0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pShow Position",    Icon_ShowPosition,              0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pTake Screenshot",  Icon_Screenshot,                0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},
  { "\pReset Textures",   Icon_ResetTxtrs,                0,
    kISpElementKind_Button,              kISpElementLabel_None,
    kISpNeedFlag_Button_AlreadyAxis, 0, 0, 0},

  // Axis stuff
  { "\pLook Horizontal",  Icon_LookHorizontal,    0, kISpElementKind_Delta,
    kISpElementLabel_Delta_Yaw,
    kISpNeedFlag_Delta_AlreadyButton, 0, 0, 0},
  { "\pLook Vertical",    Icon_LookVertical,              0,
    kISpElementKind_Delta,               kISpElementLabel_Delta_Pitch,
    kISpNeedFlag_Delta_AlreadyButton, 0, 0, 0},
  { "\pMove",                             Icon_Move,
    0, kISpElementKind_Delta,               kISpElementLabel_Delta_Z,
    kISpNeedFlag_Delta_AlreadyButton, 0, 0, 0},
  { "\pChange Weapon",    Icon_ChangeWeapon,              0,
    kISpElementKind_Delta,               kISpElementLabel_Delta_Z,
    kISpNeedFlag_Delta_AlreadyButton, 0, 0, 0},
};
...
void initialize_ISp(void)
{
  ...
  if(input_preferences->input_device==_input_sprocket_only) {
  ...
  err = ISpElement_NewVirtualFromNeeds(HowManyNeeds, gNeeds, gVirtualElements,
                                       0);
  vassert(err == noErr, csprintf(temporary, "MacOS error code: %d", err));
...
{
  if(!canDoISp) {
    return;                   // Leave function because Input Sprockets is not available
  }
#if !defined(TARGET_API_MAC_CARBON)
  OSErr err = noErr;
  err = ISpStop();
...
{
  if (!canDoISp) {
    return false;                    // Leave function because Input Sprockets is not available
  }
  if (!active) {
    return false;                  // ISp can't be using the keyboard if it is inactive
  }
...
{
  if(!active) {
    return 0;                 //Input Sprockets is not active, so return no action flags
  }
  if(!canDoISp) {
    return 0;                   //Input Sprockets is not available so return no action flags
  }
#if !defined(TARGET_API_MAC_CARBON)
  OSErr err = noErr;
  UInt32 data;
...
/* Handle all axis data!!! **********************************************/
  ...
  ISpElement_GetComplexState(gVirtualElements[Axis_LookHorizontal],
                             sizeof(_fixed), &delta_yaw);
  ISpElement_GetComplexState(gVirtualElements[Axis_LookVertical], sizeof(_fixed),
                             &delta_pitch);
  ISpElement_GetComplexState(gVirtualElements[Axis_Move], sizeof(_fixed),
                             &delta_velocity);
  ISpElement_GetComplexState(gVirtualElements[Axis_ChangeWeapon], sizeof(_fixed),
                             &delta_weapon);
  ...
  if(delta_yaw != 0 || delta_pitch != 0 || delta_velocity != 0) {
    flags=
      mask_in_absolute_positioning_information(flags, delta_yaw, delta_pitch,
                                               delta_velocity);
  }
