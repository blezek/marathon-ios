...
{
  collection_definition *collection = get_collection_definition(
    Lua_Collection::Index(L, 1));
...
{
  control_panel_definition *definition = get_control_panel_definition(
    Lua_ControlPanelType::Index(L, 1));
...
{
  Lua_ControlPanelClass::Push(L,
                              get_panel_class(Lua_ControlPanelType::Index(L, 1)));
  return 1;
}
...
{
  Lua_Polygon::Push(L, get_line_data(Lua_Line::Index(L,
                                                     1))->
...
{
  Lua_Side::Push(L, get_line_data(Lua_Line::Index(L,
                                                  1))->
...
{
  lua_pushboolean(L,
                  LINE_HAS_TRANSPARENT_SIDE(get_line_data(Lua_Line::Index(L, 1))));
  return 1;
}

static int Lua_Line_Get_Highest_Adjacent_Floor(lua_State *L)
{
  lua_pushnumber(L, (double) get_line_data(Lua_Line::Index(L,
                                                           1))->
                 highest_adjacent_floor / WORLD_ONE);
  return 1;
}
...
static int Lua_Line_Get_Lowest_Adjacent_Ceiling(lua_State *L)
{
  lua_pushnumber(L, (double) get_line_data(Lua_Line::Index(L,
                                                           1))->
                 lowest_adjacent_ceiling / WORLD_ONE);
  return 1;
}
...
{
  Lua_Polygon::Push(L, get_platform_data(Lua_Platform::Index(L,
                                                             1))->polygon_index);
  return 1;
}
...
const luaL_reg Lua_Platform_Get[] = {
  ...
  {"monster_controllable",
   Lua_Platform_Get_Static_Flag<_platform_is_monster_controllable>},
  {"player_controllable",
   Lua_Platform_Get_Static_Flag<_platform_is_player_controllable>},
...
const luaL_reg Lua_Platform_Set[] = {
  ...
  {"monster_controllable",
   Lua_Platform_Set_Static_Flag<_platform_is_monster_controllable>},
  {"player_controllable",
   Lua_Platform_Set_Static_Flag<_platform_is_player_controllable>},
...
{
  Lua_Collection::Push(L,
                       GET_COLLECTION(GET_DESCRIPTOR_COLLECTION(
                                        get_polygon_data(Lua_Polygon_Floor::
                                                         Index(
                                                           L,
                                                           1))->floor_texture)));
  return 1;
...
{
  lua_pushnumber(L,
                 (double) (get_polygon_data(Lua_Polygon_Floor::Index(L,
                                                                     1))->
                           floor_height) / WORLD_ONE);
  return 1;
}

static int Lua_Polygon_Floor_Get_Light(lua_State *L)
{
  Lua_Light::Push(L, get_polygon_data(Lua_Polygon_Floor::Index(L,
                                                               1))->
...
{
  lua_pushnumber(L,
                 GET_DESCRIPTOR_SHAPE(get_polygon_data(Lua_Polygon_Floor::Index(
                                                         L,
                                                         1))
                                      ->floor_texture));
  return 1;
...
static int Lua_Polygon_Floor_Get_Texture_Y(lua_State *L)
{
  lua_pushnumber(L,
                 (double) (get_polygon_data(Lua_Polygon_Floor::Index(L,
                                                                     1))->
                           floor_origin.y) / WORLD_ONE);
  return 1;
}

static int Lua_Polygon_Floor_Get_Transfer_Mode(lua_State *L)
{
  Lua_TransferMode::Push(L, get_polygon_data(Lua_Polygon_Floor::Index(L,
                                                                      1))->
                         floor_transfer_mode);
  return 1;
}
...
static int Lua_Polygon_Floor_Set_Collection(lua_State *L)
{
  ...
  polygon->floor_texture = BUILD_DESCRIPTOR(
    collection_index, GET_DESCRIPTOR_SHAPE(polygon->floor_texture));
  return 0;
}
...
static int Lua_Polygon_Floor_Set_Light(lua_State *L)
{
  ...
  get_polygon_data(Lua_Polygon_Floor::Index(L,
                                            1))->floor_lightsource_index =
    light_index;
  return 0;
}
...
static int Lua_Polygon_Floor_Set_Texture_Index(lua_State *L)
{
  ...
  polygon->floor_texture =
    BUILD_DESCRIPTOR(GET_DESCRIPTOR_COLLECTION(
                       polygon->floor_texture), shape_index);
  return 0;
}
...
static int Lua_Polygon_Ceiling_Get_Collection(lua_State *L)
{
  Lua_Collection::Push(L,
                       GET_COLLECTION(GET_DESCRIPTOR_COLLECTION(
                                        get_polygon_data(Lua_Polygon_Ceiling
                                                         ::
                                                         Index(L,
                                                               1))->ceiling_texture)));
  return 1;
...
{
  lua_pushnumber(L,
                 (double) (get_polygon_data(Lua_Polygon_Ceiling::Index(L,
                                                                       1))->
                           ceiling_height) / WORLD_ONE);
  return 1;
}

static int Lua_Polygon_Ceiling_Get_Light(lua_State *L)
{
  Lua_Light::Push(L, get_polygon_data(Lua_Polygon_Ceiling::Index(L,
                                                                 1))->
...
{
  lua_pushnumber(L,
                 GET_DESCRIPTOR_SHAPE(get_polygon_data(Lua_Polygon_Ceiling::
                                                       Index(L,
                                                             1))
                                      ->ceiling_texture));
  return 1;
...
static int Lua_Polygon_Ceiling_Get_Texture_Y(lua_State *L)
{
  lua_pushnumber(L,
                 (double) (get_polygon_data(Lua_Polygon_Ceiling::Index(L,
                                                                       1))->
                           ceiling_origin.y) / WORLD_ONE);
  return 1;
}

static int Lua_Polygon_Ceiling_Get_Transfer_Mode(lua_State *L)
{
  Lua_TransferMode::Push(L, get_polygon_data(Lua_Polygon_Ceiling::Index(L,
                                                                        1))->
                         ceiling_transfer_mode);
  return 1;
}
...
static int Lua_Polygon_Ceiling_Set_Collection(lua_State *L)
{
  ...
  polygon_data *polygon = get_polygon_data(polygon_index);
  polygon->ceiling_texture = BUILD_DESCRIPTOR(
    collection_index, GET_DESCRIPTOR_SHAPE(polygon->ceiling_texture));
  return 0;
}
...
static int Lua_Polygon_Ceiling_Set_Height(lua_State *L)
{
  ...
  struct polygon_data *polygon =
    get_polygon_data(Lua_Polygon_Ceiling::Index(L, 1));
...
static int Lua_Polygon_Ceiling_Set_Light(lua_State *L)
{
  ...
  get_polygon_data(Lua_Polygon_Ceiling::Index(L,
                                              1))->ceiling_lightsource_index =
    light_index;
  return 0;
}
...
static int Lua_Polygon_Ceiling_Set_Texture_Index(lua_State *L)
{
  ...
  polygon->ceiling_texture =
    BUILD_DESCRIPTOR(GET_DESCRIPTOR_COLLECTION(
                       polygon->ceiling_texture), shape_index);
  return 0;
}
...
typedef L_EnumContainer<Lua_PolygonTypes_Name,
                        Lua_PolygonType> Lua_PolygonTypes;
...
static int Lua_Adjacent_Polygons_Get(lua_State *L)
{
  if (lua_isnumber(L, 2)) {
    ...
    if (adjacent_polygon_index >= 0 && adjacent_polygon_index <
        polygon->vertex_count) {
      Lua_Polygon::Push(L,
                        polygon->adjacent_polygon_indexes[
...
{
  lua_pushnumber(L, get_polygon_data(Lua_Adjacent_Polygons::Index(L,
                                                                  1))->
                 vertex_count);
  return 1;
}
...
{
  lua_pushnumber(L, get_polygon_data(Lua_Polygon_Endpoints::Index(L,
                                                                  1))->
                 vertex_count);
  return 1;
}
...
{
  lua_pushnumber(L, get_polygon_data(Lua_Polygon_Lines::Index(L,
                                                              1))->vertex_count);
  return 1;
}
...
{
  lua_pushnumber(L, get_polygon_data(Lua_Polygon_Sides::Index(L,
                                                              1))->vertex_count);
  return 1;
}
...
int Lua_Polygon_Contains(lua_State *L)
{
  ...
  lua_pushboolean(L, point_in_polygon(polygon_index,
                                      &p) && z >= polygon->floor_height && z <=
                  polygon->ceiling_height);
  return 1;
}
...
int Lua_Polygon_Find_Line_Crossed_Leaving(lua_State *L)
{
  ...
  short line_index = find_line_crossed_leaving_polygon(Lua_Polygon::Index(L,
                                                                          1),
                                                       &origin, &destination);
  if (line_index != NONE) {
...
{
  lua_pushnumber(L, (double) get_polygon_data(Lua_Polygon::Index(L,
                                                                 1))->area /
                 WORLD_ONE / WORLD_ONE);
  return 1;
}
...
const luaL_reg Lua_Polygon_Get[] = {
  ...
  {"find_line_crossed_leaving",
   L_TableFunction<Lua_Polygon_Find_Line_Crossed_Leaving>},
...
{
  Lua_ControlPanelType::Push(L, get_side_data(Lua_Side_ControlPanel::Index(L,
                                                                           1))
                             ->control_panel_type);
  return 1;
}
...
{
  lua_pushnumber(L, get_side_data(Lua_Side_ControlPanel::Index(L,
                                                               1))->
...
const luaL_reg Lua_Side_ControlPanel_Get[] = {
  {"can_be_destroyed",
   Lua_Side_ControlPanel_Get_Flag<_side_switch_can_be_destroyed>},
  {"light_dependent", Lua_Side_ControlPanel_Get_Flag<_side_is_lighted_switch>},
  {"only_toggled_by_weapons",
   Lua_Side_ControlPanel_Get_Flag<_side_switch_can_only_be_hit_by_projectiles>},
...
const luaL_reg Lua_Side_ControlPanel_Set[] = {
  {"can_be_destroyed",
   Lua_Side_ControlPanel_Set_Flag<_side_switch_can_be_destroyed>},
  {"light_dependent", Lua_Side_ControlPanel_Set_Flag<_side_is_lighted_switch>},
  {"only_toggled_by_weapons",
   Lua_Side_ControlPanel_Set_Flag<_side_switch_can_only_be_hit_by_projectiles>},
...
{
  Lua_Collection::Push(L,
                       GET_COLLECTION(GET_DESCRIPTOR_COLLECTION(get_side_data(
                                                                  Lua_Primary_Side
                                                                  ::Index(
                                                                    L,
                                                                    1))->
...
{
  Lua_Light::Push(L, get_side_data(Lua_Primary_Side::Index(L,
                                                           1))->
...
{
  lua_pushnumber(L,
                 GET_DESCRIPTOR_SHAPE(get_side_data(Lua_Primary_Side::Index(L,
                                                                            1))
                                      ->primary_texture.texture));
  return 1;
}
...
{
  lua_pushnumber(L,
                 (double) (get_side_data(Lua_Primary_Side::Index(L,
                                                                 1))->
                           primary_texture.x0) / WORLD_ONE);
  return 1;
}
...
static int Lua_Primary_Side_Get_Texture_Y(lua_State *L)
{
  lua_pushnumber(L,
                 (double) (get_side_data(Lua_Primary_Side::Index(L,
                                                                 1))->
                           primary_texture.y0) / WORLD_ONE);
  return 1;
}

static int Lua_Primary_Side_Get_Transfer_Mode(lua_State *L)
{
  Lua_TransferMode::Push(L, get_side_data(Lua_Primary_Side::Index(L,
                                                                  1))->
...
static void update_line_redundancy(short line_index)
{
  ...
  if (line->counterclockwise_polygon_side_index!=NONE) {
    counterclockwise_side= get_side_data(
      line->counterclockwise_polygon_side_index);
  }

  if ((clockwise_side&&clockwise_side->primary_transfer_mode==
       _xfer_landscape) ||
      (counterclockwise_side&&counterclockwise_side->primary_transfer_mode==
       _xfer_landscape)) {
    landscaped= true;
  }

  if ((clockwise_side && clockwise_side->transparent_texture.texture!=UNONE) ||
      (counterclockwise_side &&
       counterclockwise_side->transparent_texture.texture!=UNONE)) {
...
static int Lua_Primary_Side_Set_Collection(lua_State *L)
{
  ...
  side->primary_texture.texture = BUILD_DESCRIPTOR(
    collection_index, GET_DESCRIPTOR_SHAPE(side->primary_texture.texture));
...
static int Lua_Primary_Side_Set_Light(lua_State *L)
{
  ...
  get_side_data(Lua_Polygon_Floor::Index(L,
                                         1))->primary_lightsource_index =
    light_index;
  return 0;
}
static int Lua_Primary_Side_Set_Texture_Index(lua_State *L)
{
  ...
  side->primary_texture.texture =
    BUILD_DESCRIPTOR(GET_DESCRIPTOR_COLLECTION(
                       side->primary_texture.texture), shape_index);
  update_line_redundancy(side->line_index);
  return 0;
}
...
static int Lua_Secondary_Side_Get_Collection(lua_State *L)
{
  Lua_Collection::Push(L,
                       GET_COLLECTION(GET_DESCRIPTOR_COLLECTION(get_side_data(
                                                                  ...
                                                                  Index(
                                                                    L,
                                                                    1))->secondary_texture.texture)));
  return 1;
}

static int Lua_Secondary_Side_Get_Light(lua_State *L)
{
  Lua_Light::Push(L, get_side_data(Lua_Secondary_Side::Index(L,
                                                             1))->
...
{
  lua_pushnumber(L,
                 GET_DESCRIPTOR_SHAPE(get_side_data(Lua_Secondary_Side::Index(L,
                                                                              1))
...
{
  lua_pushnumber(L,
                 (double) (get_side_data(Lua_Secondary_Side::Index(L,
                                                                   1))->
                           secondary_texture.x0) / WORLD_ONE);
  return 1;
}
...
static int Lua_Secondary_Side_Get_Texture_Y(lua_State *L)
{
  lua_pushnumber(L,
                 (double) (get_side_data(Lua_Secondary_Side::Index(L,
                                                                   1))->
                           secondary_texture.y0) / WORLD_ONE);
  return 1;
}

static int Lua_Secondary_Side_Get_Transfer_Mode(lua_State *L)
{
  Lua_TransferMode::Push(L, get_side_data(Lua_Secondary_Side::Index(L,
                                                                    1))->
...
static int Lua_Secondary_Side_Set_Collection(lua_State *L)
{
  ...
  side_data *side = get_side_data(side_index);
  side->secondary_texture.texture = BUILD_DESCRIPTOR(
    collection_index, GET_DESCRIPTOR_SHAPE(side->secondary_texture.texture));
  update_line_redundancy(side->line_index);
  return 0;
}
...
static int Lua_Secondary_Side_Set_Texture_Index(lua_State *L)
{
  ...
  side->secondary_texture.texture =
    BUILD_DESCRIPTOR(GET_DESCRIPTOR_COLLECTION(
                       side->secondary_texture.texture), shape_index);
  update_line_redundancy(side->line_index);
  return 0;
}
...
static int Lua_Transparent_Side_Get_Collection(lua_State *L)
{
  Lua_Collection::Push(L,
                       GET_COLLECTION(GET_DESCRIPTOR_COLLECTION(get_side_data(
                                                                  Lua_Transparent_Side
                                                                  ::
                                                                  Index(
                                                                    L,
                                                                    1))->transparent_texture.texture)));
  return 1;
}

static int Lua_Transparent_Side_Get_Empty(lua_State *L)
{
  lua_pushboolean(L, get_side_data(Lua_Transparent_Side::Index(L,
                                                               1))->
                  transparent_texture.texture == UNONE);
  return 1;
}

static int Lua_Transparent_Side_Get_Light(lua_State *L)
{
  Lua_Light::Push(L, get_side_data(Lua_Transparent_Side::Index(L,
                                                               1))->
...
{
  lua_pushnumber(L,
                 GET_DESCRIPTOR_SHAPE(get_side_data(Lua_Transparent_Side::Index(
                                                      L,
                                                      1))
...
{
  lua_pushnumber(L,
                 (double) (get_side_data(Lua_Transparent_Side::Index(L,
                                                                     1))->
                           transparent_texture.x0) / WORLD_ONE);
  return 1;
}
...
static int Lua_Transparent_Side_Get_Texture_Y(lua_State *L)
{
  lua_pushnumber(L,
                 (double) (get_side_data(Lua_Transparent_Side::Index(L,
                                                                     1))->
                           transparent_texture.y0) / WORLD_ONE);
  return 1;
}

static int Lua_Transparent_Side_Get_Transfer_Mode(lua_State *L)
{
  Lua_TransferMode::Push(L, get_side_data(Lua_Transparent_Side::Index(L,
                                                                      1))->
...
static int Lua_Transparent_Side_Set_Collection(lua_State *L)
{
  ...
  side_data *side = get_side_data(side_index);
  side->transparent_texture.texture = BUILD_DESCRIPTOR(
    collection_index, GET_DESCRIPTOR_SHAPE(side->transparent_texture.texture));
  update_line_redundancy(side->line_index);
  return 0;
}
...
static int Lua_Transparent_Side_Set_Light(lua_State *L)
{
  ...
  get_side_data(Lua_Polygon_Floor::Index(L,
                                         1))->transparent_lightsource_index =
    light_index;
  return 0;
}
...
static int Lua_Transparent_Side_Set_Texture_Index(lua_State *L)
{
  ...
  side->transparent_texture.texture = BUILD_DESCRIPTOR(
    GET_DESCRIPTOR_COLLECTION(side->transparent_texture.texture), shape_index);
  update_line_redundancy(side->line_index);
  return 0;
}
...
static int Lua_Side_Set_Control_Panel(lua_State *L)
{
  ...
  if (lua_toboolean(L, 2) != (side->flags & _side_is_control_panel)) {
    ...
    side->flags &=
      ~(_control_panel_status | _side_is_control_panel |
        _side_is_repair_switch |
        _side_is_destructive_switch | _side_is_lighted_switch |
        _side_switch_can_be_destroyed |
...
typedef L_EnumContainer<Lua_LightFunctions_Name,
                        Lua_LightFunction> Lua_LightFunctions;
...
typedef L_EnumContainer<Lua_LightPresets_Name,
                        Lua_LightPreset> Lua_LightPresets;
...
Lua_Light_State* Lua_Light_State::Push(lua_State* L, int16 light_index,
                                       int16 index)
{
  Lua_Light_State* t = 0;
...
static lighting_function_specification* get_light_function_spec(int light_index,
                                                                int state)
{
...
static int Lua_Light_State_Get_Delta_Intensity(lua_State* L)
{
  ...
  lighting_function_specification* spec = get_light_function_spec(
    light_index, Lua_Light_State::Index(L, 1));
...
static int Lua_Light_State_Set_Delta_Intensity(lua_State* L)
{
  ...
  lighting_function_specification* spec = get_light_function_spec(
    Lua_Light_State::LightIndex(L, 1), Lua_Light_State::Index(L, 1));
...
{
  lua_pushnumber(L,
                 static_cast<double>(get_light_intensity(Lua_Light::Index(L,
                                                                          1)))
                 / FIXED_ONE);
  return 1;
}
...
static int Lua_Light_Set_Active(lua_State *L)
{
  ...
  assume_correct_switch_position(_panel_is_light_switch,
                                 static_cast<short>(light_index), active);
  return 0;
}
...
static int16 Lua_Lights_Length() {
...
static int Lua_Tag_Get_Active(lua_State *L)
{
  ...
  for (light_index= 0, light= lights;
       light_index<MAXIMUM_LIGHTS_PER_MAP && !changed; ++light_index, ++light)
  {
  ...
  for (platform_index= 0, platform= platforms;
       platform_index<dynamic_world->platform_count && !changed;
...
bool Lua_Tag_Valid(int16 index) {
  return index >= 0;
}
...
static int Lua_Media_Get_Direction(lua_State* L)
{
  ...
  lua_pushnumber(L,
                 static_cast<double>(media->current_direction) * AngleConvert);
  return 1;
}
...
static int Lua_Media_Set_Direction(lua_State* L)
{
  ...
  media_data* media = get_media_data(Lua_Media::Index(L, 1));
  media->current_direction =
    static_cast<angle>(lua_tonumber(L, 2) / AngleConvert);
  return 0;
}
...
static int16 Lua_Medias_Length() {
...
{
  Lua_Polygon::Push(L, MapAnnotationList[Lua_Annotation::Index(L,
                                                               1)].
                    polygon_index);
  return 1;
}
...
{
  lua_pushnumber(L, (double) MapAnnotationList[Lua_Annotation::Index(L,
                                                                     1)].
                 location.x / WORLD_ONE);
  return 1;
}
...
static int Lua_Annotation_Set_Text(lua_State *L)
{
  ...
  strncpy(MapAnnotationList[annotation_index].text, lua_tostring(L,
                                                                 2),
          MAXIMUM_ANNOTATION_TEXT_LENGTH);
  MapAnnotationList[annotation_index].text[MAXIMUM_ANNOTATION_TEXT_LENGTH-
                                           1] = '\0';
  return 0;
}
...
static int Lua_Annotation_Set_X(lua_State *L)
{
  ...
  MapAnnotationList[Lua_Annotation::Index(L,
                                          1)].location.x =
    static_cast<int>(lua_tonumber(L, 2) * WORLD_ONE);
  return 0;
}
...
{
  lua_pushnumber(L,
                 (float) (OGL_GetFogData(Lua_Fog_Color::Index(L,
                                                              1))->Color.red) /
                 65535);
  return 1;
}
...
static int Lua_Fog_Color_Set_R(lua_State *L)
{
  ...
  OGL_GetFogData(Lua_Fog_Color::Index(L,
                                      1))->Color.red =
    PIN(int(65535 * color + 0.5), 0, 65535);
  return 0;
}
...
static int Lua_Fog_Set_Active(lua_State *L)
{
  ...
  OGL_GetFogData(Lua_Fog::Index(L,
                                1))->IsPresent =
...
typedef L_EnumContainer<Lua_CompletionStates_Name,
                        Lua_CompletionState> Lua_CompletionStates;
...
const luaL_reg Lua_Level_Get[] = {
  {"calculate_completion_state",
   L_TableFunction<Lua_Level_Calculate_Completion_State>},
...
{
  Lua_Collection::Register(L, Lua_Collection_Get, 0, 0,
                           Lua_Collection_Mnemonics);
  ...
  Lua_CompletionState::Valid =
    Lua_CompletionState::ValidRange(static_cast<int16>(_level_failed) + 1);
  Lua_CompletionStates::Register(L);
  Lua_CompletionStates::Length = Lua_CompletionStates::ConstantLength(
    static_cast<int16>(_level_failed) + 1);

  Lua_ControlPanelClass::Register(L, 0, 0, 0, Lua_ControlPanelClass_Mnemonics);
  Lua_ControlPanelClass::Valid = Lua_ControlPanelClass::ValidRange(
    NUMBER_OF_CONTROL_PANELS);

  Lua_ControlPanelClasses::Register(L);
  Lua_ControlPanelClasses::Length = Lua_ControlPanelClasses::ConstantLength(
    NUMBER_OF_CONTROL_PANELS);

  Lua_ControlPanelType::Register(L, Lua_ControlPanelType_Get);
  Lua_ControlPanelType::Valid = Lua_ControlPanelType::ValidRange(
    NUMBER_OF_CONTROL_PANEL_DEFINITIONS);

  Lua_ControlPanelTypes::Register(L);
  Lua_ControlPanelTypes::Length = Lua_ControlPanelTypes::ConstantLength(
    NUMBER_OF_CONTROL_PANEL_DEFINITIONS);
  ...
  Lua_DamageTypes::Length = Lua_DamageTypes::ConstantLength(
...
//	Lua_Endpoints::Length = boost::bind(&std::vector<endpoint_data>::size, &EndpointList);
  ...
  Lua_PlatformType::Valid = Lua_PlatformType::ValidRange(
    NUMBER_OF_PLATFORM_TYPES);

  Lua_PlatformTypes::Register(L);
  Lua_PlatformTypes::Length = Lua_PlatformTypes::ConstantLength(
    NUMBER_OF_PLATFORM_TYPES);
  ...
  Lua_Polygon_Ceiling::Register(L, Lua_Polygon_Ceiling_Get,
                                Lua_Polygon_Ceiling_Set);
  Lua_Polygon_Ceiling::Valid = Lua_Polygon_Valid;

  Lua_PolygonType::Register(L, 0, 0, 0, Lua_PolygonType_Mnemonics);
  Lua_PolygonType::Valid =
    Lua_PolygonType::ValidRange(static_cast<int16>(_polygon_is_superglue) + 1);

  Lua_PolygonTypes::Register(L);
  Lua_PolygonTypes::Length =
    Lua_PolygonTypes::ConstantLength(
      static_cast<int16>(_polygon_is_superglue) + 1);
  ...
  Lua_SideType::Valid = Lua_SideType::ValidRange(
    static_cast<int16>(_split_side) + 1);
  Lua_SideTypes::Register(L);
  Lua_SideTypes::Length =
    Lua_SideTypes::ConstantLength(static_cast<int16>(_split_side) + 1);

  Lua_Light_State::Register(L, Lua_Light_State_Get, Lua_Light_State_Set);
  Lua_Light_State::Valid =
    Lua_Light_State::ValidRange(
      static_cast<int16>(_light_secondary_inactive) + 1);
  ...
  Lua_LightPresets::Length = Lua_LightPresets::ConstantLength(
    NUMBER_OF_LIGHT_TYPES);

  Lua_LightFunction::Register(L, 0, 0, 0, Lua_LightFunction_Mnenonics);
  Lua_LightFunction::Valid = Lua_LightFunction::ValidRange(
    NUMBER_OF_LIGHTING_FUNCTIONS);

  Lua_LightFunctions::Register(L);
  Lua_LightFunctions::Length = Lua_LightFunctions::ConstantLength(
    NUMBER_OF_LIGHTING_FUNCTIONS);

  Lua_LightState::Register(L, 0, 0, 0, Lua_LightState_Mnemonics);
  Lua_LightState::Valid =
    Lua_LightState::ValidRange(
      static_cast<int16>(_light_secondary_inactive) + 1);

  Lua_LightStates::Register(L);
  Lua_LightStates::Length =
    Lua_LightStates::ConstantLength(
      static_cast<int16>(_light_secondary_inactive) + 1);
  ...
  Lua_TransferMode::Valid = Lua_TransferMode::ValidRange(
    NUMBER_OF_TRANSFER_MODES);

  Lua_TransferModes::Register(L);
  Lua_TransferModes::Length = Lua_TransferModes::ConstantLength(
    NUMBER_OF_TRANSFER_MODES);
...
static void compatibility(lua_State *L)
{
  luaL_loadbuffer(L, compatibility_script, strlen(
                    compatibility_script), "map_compatibility");
  lua_pcall(L, 0, 0, 0);
}
