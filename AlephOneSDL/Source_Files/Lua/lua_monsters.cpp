...
typedef L_EnumContainer<Lua_MonsterClasses_Name,
                        Lua_MonsterClass> Lua_MonsterClasses;

template<>
int L_Container<Lua_MonsterClasses_Name, Lua_MonsterClass>::_iterator(
  lua_State *L)
{
...
static int Lua_MonsterType_Get_Class(lua_State *L) {
  monster_definition *definition = get_monster_definition_external(
    Lua_MonsterType::Index(L, 1));
...
typedef L_EnumContainer<Lua_MonsterModes_Name,
                        Lua_MonsterMode> Lua_MonsterModes;

char Lua_MonsterAction_Name[] = "monster_action";

char Lua_MonsterActions_Name[] = "MonsterActions";
typedef L_EnumContainer<Lua_MonsterActions_Name,
                        Lua_MonsterAction> Lua_MonsterActions;

char Lua_MonsterTypes_Name[] = "MonsterTypes";
typedef L_EnumContainer<Lua_MonsterTypes_Name,
                        Lua_MonsterType> Lua_MonsterTypes;
...
int Lua_Monster_Accelerate(lua_State *L)
{
  ...
  // DJB Remove warning monster_data *monster = get_monster_data(monster_index);
  ...
  accelerate_monster(monster_index,
...
int Lua_Monster_Damage(lua_State *L)
{
  ...
  damage_monster(monster_index, NONE, NONE, &(monster->sound_location), &damage,
                 NONE);
  return 0;
}
...
int Lua_Monster_Valid(int16 index)
{
  ...
  monster_data *monster = GetMemberWithBounds(monsters, index,
...
extern int32 monster_pathfinding_cost_function(short source_polygon_index,
                                               short line_index,
                                               short destination_polygon_index,
                                               void *data);
extern void set_monster_action(short monster_index, short action);
extern void set_monster_mode(short monster_index, short new_mode,
                             short target_index);
...
int Lua_Monster_Move_By_Path(lua_State *L)
{
  ...
  monster->path =
    new_path((world_point2d *) &object->location, object->polygon, &destination,
             polygon_index, 3 * definition->radius,
             monster_pathfinding_cost_function,
             &path);
  if (monster->path == NONE) {
    if (monster->action != _monster_is_being_hit ||
...
extern void add_object_to_polygon_object_list(short object_index,
                                              short polygon_index);
...
int Lua_Monsters_register(lua_State *L)
{
  ...
  Lua_MonsterClasses::Length = Lua_MonsterClasses::ConstantLength(
    _class_yeti_bit + 1);
  ...
  Lua_MonsterType_Immunities::Register(L, 0, 0,
                                       Lua_MonsterType_Immunities_Metatable);
  Lua_MonsterType_Weaknesses::Register(L, 0, 0,
                                       Lua_MonsterType_Weaknesses_Metatable);
  ...
  Lua_MonsterModes::Length = Lua_MonsterModes::ConstantLength(
    NUMBER_OF_MONSTER_MODES);

  Lua_MonsterAction::Register(L, 0, 0, 0, Lua_MonsterAction_Mnemonics);
  Lua_MonsterAction::Valid = Lua_MonsterAction::ValidRange(
    NUMBER_OF_MONSTER_ACTIONS);
  Lua_MonsterActions::Register(L);
  Lua_MonsterActions::Length = Lua_MonsterActions::ConstantLength(
    NUMBER_OF_MONSTER_ACTIONS);

  Lua_MonsterType::Register(L, Lua_MonsterType_Get, Lua_MonsterType_Set, 0,
                            Lua_MonsterType_Mnemonics);
  Lua_MonsterType::Valid = Lua_MonsterType_Valid;

  Lua_MonsterTypes::Register(L);
  Lua_MonsterTypes::Length = Lua_MonsterTypes::ConstantLength(
  ...
  Lua_Monsters::Length = boost::bind(get_dynamic_limit,
                                     (int) _dynamic_limit_monsters);
...
static void compatibility(lua_State *L)
{
  luaL_loadbuffer(L, compatibility_script, strlen(
                    compatibility_script), "monsters_compatibility");
  lua_pcall(L, 0, 0, 0);
}
