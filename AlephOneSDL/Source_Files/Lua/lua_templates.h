...
static void Register(lua_State *L, const luaL_reg get[] = 0,
                     const luaL_reg set[] = 0,
...
template<char *name, typename index_t>
void L_Class<name, index_t>::Register(lua_State *L, const luaL_reg get[],
                                      const luaL_reg set[],
...
template<char *name, typename index_t>
L_Class<name, index_t> *L_Class<name, index_t>::Push(lua_State *L,
                                                     index_t index)
{
  ...
  if (lua_isnil(L, -1)) {
    ...
    // create an instance
    t =
      static_cast<L_Class<name, index_t> *>(lua_newuserdata(L,
                                                            sizeof(L_Class<name,
                                                                           index_t>)));
...
index_t L_Class<name, index_t>::Index(lua_State *L, int index)
{
  L_Class<name,
          index_t> *t =
    static_cast<L_Class<name, index_t> *>(lua_touserdata(L, index));
  if (!t) {
...
public:
static void Register(lua_State *L, const luaL_reg get[] = 0,
                     const luaL_reg set[] = 0, const luaL_reg metatable[] = 0,
                     const lang_def mnemonics[] = 0);
...
class L_Container {
public:
static void Register(lua_State *L, const luaL_reg methods[] = 0,
                     const luaL_reg metatable[] = 0);
...
template<char *name, class T>
boost::function<typename T::index_type (void)> L_Container<name,
                                                           T>::Length =
  ConstantLength(1);

template<char *name, class T>
void L_Container<name, T>::Register(lua_State *L, const luaL_reg methods[],
                                    const luaL_reg metatable[])
{
  lua_newuserdata(L, 0);
...
template <char *name, class T>
void L_EnumContainer<name, T>::Register(lua_State *L, const luaL_reg methods[],
                                        const luaL_reg metatable[])
{
...
public:
static L_ObjectClass<name, object_t, index_t> *Push(lua_State *L,
                                                    object_t object);
...
template<char *name, typename object_t, typename index_t>
boost::function<bool (index_t)> L_ObjectClass<name, object_t,
                                              index_t>::Valid =
  object_valid<name, object_t, index_t>();


template<char *name, typename object_t, typename index_t>
L_ObjectClass<name, object_t, index_t> *L_ObjectClass<name, object_t,
                                                      index_t>::Push(
  lua_State *L, object_t object)
{
  ...
  // create an instance
  L_ObjectClass<name, object_t,
                index_t> *t =
    static_cast<L_ObjectClass<name, object_t, index_t> *>(lua_newuserdata(L,
                                                                          sizeof(
                                                                            L_ObjectClass
                                                                            <name, object_t, index_t>)));
  luaL_getmetatable(L, name);
  lua_setmetatable(L, -2);
  t->m_index = idx;
...
template<char *name, typename object_t, typename index_t>
object_t L_ObjectClass<name, object_t, index_t>::ObjectAtIndex(lua_State *L,
                                                               index_t index)
{
...
template<char *name, typename object_t, typename index_t>
void L_ObjectClass<name, object_t, index_t>::Invalidate(lua_State *L,
                                                        index_t index)
{
