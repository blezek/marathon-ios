...
void OverheadMap_SDL_Class::draw_thing(world_point2d &center, rgb_color &color, short shape, short radius)
{
	...
	switch (shape) {
        ...
        {static_cast<world_distance>(int16(-0.75 * radius) + center.x), static_cast<world_distance>(int16(-0.3 * radius) + center.y)},
        {static_cast<world_distance>(int16(-0.75 * radius) + center.x), static_cast<world_distance>(int16(0.3 * radius) + center.y)},
        {static_cast<world_distance>(int16(-0.3 * radius) + center.x), static_cast<world_distance>(int16(0.75 * radius) + center.y)},
        {static_cast<world_distance>(int16(0.3 * radius) + center.x), static_cast<world_distance>(int16(0.75 * radius) + center.y)},
        {static_cast<world_distance>(int16(0.75 * radius) + center.x), static_cast<world_distance>(int16(0.3 * radius) + center.y)},
        {static_cast<world_distance>(int16(0.75 * radius) + center.x), static_cast<world_distance>(int16(-0.3 * radius) + center.y)},
        {static_cast<world_distance>(int16(0.3 * radius) + center.x), static_cast<world_distance>(int16(-0.75 * radius) + center.y)},
