...
int
TextLayoutHelper::reserveSpaceFor(int inLeft, unsigned int inWidth,
                                  int inLowestBottom,
  ...
  CollectionOfReservationPointers::const_iterator end3                    =
    theReservations.end();
  ...
  do {
    ...
    for(; k != end3; k++) {
      ...
      if(((*k)->mBottom > theCurrentBottom - static_cast<int>(inHeight)) &&
         ((*k)->mTop < theCurrentBottom)) {
