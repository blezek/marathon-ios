...
#define FADES_RANDOM() ((fades_random_seed&1) ? (fades_random_seed= \
                                                   (fades_random_seed>> \
                                                    1)^ \
                                                   0xb400) : (fades_random_seed>>= 1))

/* ---------- types */

typedef void (*fade_proc)(struct color_table *original_color_table,
...
#define SET_FADE_ACTIVE_STATUS(f, \
                               s) ((void)((s) ? ((f)->flags|= \
                                                   (uint16)0x8000) : ((f)-> \
                                                                      flags&=(uint16) ~0x8000)))
...
static void tint_color_table(struct color_table *original_color_table,
                             struct color_table *animated_color_table,
                             struct rgb_color *color,
                             _fixed transparency);
static void randomize_color_table(struct color_table *original_color_table,
                                  struct color_table *animated_color_table,
                                  struct rgb_color *color,
                                  _fixed transparency);
static void negate_color_table(struct color_table *original_color_table,
                               struct color_table *animated_color_table,
                               struct rgb_color *color,
                               _fixed transparency);
static void dodge_color_table(struct color_table *original_color_table,
                              struct color_table *animated_color_table,
                              struct rgb_color *color,
                              _fixed transparency);
static void burn_color_table(struct color_table *original_color_table,
                             struct color_table *animated_color_table,
                             struct rgb_color *color,
                             _fixed transparency);
static void soft_tint_color_table(struct color_table *original_color_table,
                                  struct color_table *animated_color_table,
                                  struct rgb_color *color,
                                  _fixed transparency);
...
static struct fade_definition fade_definitions[NUMBER_OF_FADE_TYPES]=
{
  ...
  {tint_color_table,
   {0, 0, 0}, FIXED_ONE, 0, MACHINE_TICKS_PER_SECOND/2, _full_screen_flag, 0},                         /* _cinematic_fade_in */
  {tint_color_table,
   {0, 0, 0}, FIXED_ONE, 0, 3*MACHINE_TICKS_PER_SECOND/2, _full_screen_flag, 0},                         /* _long_cinematic_fade_in */
  {tint_color_table,
   {0, 0, 0}, 0, FIXED_ONE, MACHINE_TICKS_PER_SECOND/2, _full_screen_flag, 0},                         /* _cinematic_fade_out */
  {tint_color_table, {0, 0, 0}, 0, 0, 0, _full_screen_flag, 0},       /* _end_cinematic_fade_out */

  {tint_color_table,
   {65535, 0, 0}, (3*FIXED_ONE)/4, 0, MACHINE_TICKS_PER_SECOND/4, 0, 0},                         /* _fade_red */
  {tint_color_table,
   {65535, 0, 0}, FIXED_ONE, 0, (3*MACHINE_TICKS_PER_SECOND)/4, 0, 0},                         /* _fade_big_red */
  {tint_color_table,
   {0, 65535, 0}, FIXED_ONE_HALF, 0, MACHINE_TICKS_PER_SECOND/4, 0, 0},                         /* _fade_bonus */
  {tint_color_table,
   {65535, 65535, 50000}, FIXED_ONE, 0, MACHINE_TICKS_PER_SECOND/3, 0, 0},                         /* _fade_bright */
  {tint_color_table,
   {65535, 65535, 50000}, FIXED_ONE, 0, 4*MACHINE_TICKS_PER_SECOND, 0, 1},                         /* _fade_long_bright */
  {tint_color_table,
   {65535, 65535, 0}, FIXED_ONE, 0, MACHINE_TICKS_PER_SECOND/2, 0, 0},                         /* _fade_yellow */
  {tint_color_table,
   {65535, 65535, 0}, FIXED_ONE, 0, MACHINE_TICKS_PER_SECOND, 0, 0},                         /* _fade_big_yellow */
  {tint_color_table,
   {215*256, 107*256,
    65535}, (3*FIXED_ONE)/4, 0, MACHINE_TICKS_PER_SECOND/4, 0, 0},                                           /* _fade_purple */
  {tint_color_table,
   {169*256, 65535,
    224*256}, (3*FIXED_ONE)/4, 0, MACHINE_TICKS_PER_SECOND/2, 0, 0},                                         /* _fade_cyan */
  {tint_color_table,
   {65535, 65535, 65535}, FIXED_ONE_HALF, 0, MACHINE_TICKS_PER_SECOND/4, 0, 0},                         /* _fade_white */
  {tint_color_table,
   {65535, 65535, 65535}, FIXED_ONE, 0, MACHINE_TICKS_PER_SECOND/2, 0, 0},                         /* _fade_big_white */
  {tint_color_table,
   {65535, 32768, 0}, FIXED_ONE, 0, MACHINE_TICKS_PER_SECOND/4, 0, 0},                         /* _fade_orange */
  {tint_color_table,
   {65535, 32768, 0}, FIXED_ONE/4, 0, 3*MACHINE_TICKS_PER_SECOND, 0, 0},                         /* _fade_long_orange */
  {tint_color_table,
   {0, 65535, 0}, 3*FIXED_ONE/4, 0, MACHINE_TICKS_PER_SECOND/2, 0, 0},                         /* _fade_green */
  {tint_color_table,
   {65535, 0, 65535}, FIXED_ONE/4, 0, 3*MACHINE_TICKS_PER_SECOND, 0, 0},                         /* _fade_long_green */

  {randomize_color_table,
   {0, 0, 0}, FIXED_ONE, 0, (3*MACHINE_TICKS_PER_SECOND)/8, 0, 0},                              /* _fade_static */
  {negate_color_table,
   {65535, 65535, 65535}, FIXED_ONE, 0, MACHINE_TICKS_PER_SECOND/2, 0, 0},                           /* _fade_negative */
  {negate_color_table,
   {65535, 65535, 65535}, FIXED_ONE, 0, (3*MACHINE_TICKS_PER_SECOND)/2, 0, 0},                           /* _fade_big_negative */
  {negate_color_table,
   {0, 65535,
    0}, FIXED_ONE, 0, MACHINE_TICKS_PER_SECOND/2, _random_transparency_flag, 0},                                     /* _fade_flicker_negative */
  {dodge_color_table,
   {0, 65535, 0}, FIXED_ONE, 0, (3*MACHINE_TICKS_PER_SECOND)/4, 0, 0},                          /* _fade_dodge_purple */
  {burn_color_table,
   {0, 65535, 65535}, FIXED_ONE, 0, MACHINE_TICKS_PER_SECOND, 0, 0},                         /* _fade_burn_cyan */
  {dodge_color_table,
   {0, 0, 65535}, FIXED_ONE, 0, (3*MACHINE_TICKS_PER_SECOND)/2, 0, 0},                          /* _fade_dodge_yellow */
  {burn_color_table,
   {0, 65535, 0}, FIXED_ONE, 0, 2*MACHINE_TICKS_PER_SECOND, 0, 0},                         /* _fade_burn_green */

  {soft_tint_color_table,
   {137*256, 0, 137*256}, FIXED_ONE, 0, 2*MACHINE_TICKS_PER_SECOND, 0, 0},                              /* _fade_tint_purple */
  {soft_tint_color_table,
   {0, 0, 65535}, FIXED_ONE, 0, 2*MACHINE_TICKS_PER_SECOND, 0, 0},                              /* _fade_tint_blue */
  {soft_tint_color_table,
   {65535, 16384, 0}, FIXED_ONE, 0, 2*MACHINE_TICKS_PER_SECOND, 0, 0},                              /* _fade_tint_orange */
  {soft_tint_color_table,
   {32768, 65535, 0}, FIXED_ONE, 0, 2*MACHINE_TICKS_PER_SECOND, 0, 0},                              /* _fade_tint_gross */
...
struct fade_effect_definition fade_effect_definitions[
...
static void recalculate_and_display_color_table(
  short type, _fixed transparency,
  struct color_table *
  original_color_table, struct color_table *animated_color_table,
  bool fade_active);
...
fade_effect_definition *get_fade_effect_definition(
  const short index)
{
  return GetMemberWithBounds(fade_effect_definitions,index,
                             NUMBER_OF_FADE_EFFECT_TYPES);
}
  ...
  void)
{
  if (FADE_IS_ACTIVE(fade)) {
    ...
    if ((phase= machine_tick_count()-fade->last_update_tick)>=
        definition->period) {
    ...
    else
    {
      transparency= definition->initial_transparency +
                    (phase*
                     (definition->final_transparency-
                      definition->initial_transparency))/definition->period;
      if (definition->flags&_random_transparency_flag) {
        transparency+= FADES_RANDOM()%
                       (definition->final_transparency-transparency);
      }
    }

    recalculate_and_display_color_table(fade->type, transparency,
                                        fade->original_color_table,
                                        fade->animated_color_table,
                                        FADE_IS_ACTIVE(
                                          fade));
  }
  ...
  short type)
{
  ...
  if (ForceFEUpdate || fade->fade_effect_type!=type) {
    ...
    if (!FADE_IS_ACTIVE(fade)) {
      ...
      {
        recalculate_and_display_color_table(NONE, 0, world_color_table,
                                            visible_color_table,
                                            false);
      }
    }
  ...
  struct color_table *animated_color_table)
{
  ...
  if (FADE_IS_ACTIVE(fade)) {
    ...
    if (old_definition) {
      ...
      if (fade->type==type && machine_ticks-fade->last_update_tick<
          MINIMUM_FADE_RESTART) {
        do_fade= false;
      }
    }
  }
  ...
  void)
{
  if (FADE_IS_ACTIVE(fade)) {
    ...
    recalculate_and_display_color_table(fade->type,
                                        definition->final_transparency,
                                        fade->original_color_table,
                                        fade->animated_color_table,
                                        false);
  ...
  short gamma_level)
{
  ...
  for (i= 0; i<uncorrected_color_table->color_count;
       ++i, ++corrected, ++uncorrected)
  {
    corrected->red =
      static_cast<uint16>(pow(static_cast<float>(uncorrected->red/65535.0),
                              gamma)*65535.0);
    corrected->green =
      static_cast<uint16>(pow(static_cast<float>(uncorrected->green/65535.0),
                              gamma)*65535.0);
    corrected->blue =
      static_cast<uint16>(pow(static_cast<float>(uncorrected->blue/65535.0),
                              gamma)*65535.0);
  }
}
  ...
  bool fade_active)
{
  ...
  if (fade->fade_effect_type!=NONE) {
    struct fade_effect_definition *effect_definition=
      get_fade_effect_definition(fade->fade_effect_type);
    // LP change: idiot-proofing
    if (!effect_definition) {
      return;
    }

    struct fade_definition *definition= get_fade_definition(
      effect_definition->fade_type);
    // LP change: idiot-proofing
    if (!definition) {
      return;
    }

    definition->proc(original_color_table, animated_color_table,
                     &definition->color,
  ...
  _fixed transparency)
{
  ...
  for (i= 0; i<original_color_table->color_count; ++i, ++adjusted, ++unadjusted)
  {
    adjusted->red= (unadjusted->red>0x8000) ?
                   CEILING((unadjusted->red^color->red)+transparency,
                           (int32)unadjusted->red) :
                   FLOOR((unadjusted->red^color->red)-transparency,
                         (int32)unadjusted->red);
    adjusted->green= (unadjusted->green>0x8000) ?
                     CEILING((unadjusted->green^color->green)+transparency,
                             (int32)unadjusted->green) :
                     FLOOR((unadjusted->green^color->green)-transparency,
                           (int32)unadjusted->green);
    adjusted->blue= (unadjusted->blue>0x8000) ?
                    CEILING((unadjusted->blue^color->blue)+transparency,
                            (int32)unadjusted->blue) :
                    FLOOR((unadjusted->blue^color->blue)-transparency,
                          (int32)unadjusted->blue);
  }
}
  ...
  _fixed transparency)
{
  ...
  for (i= 0; i<original_color_table->color_count; ++i, ++adjusted, ++unadjusted)
  {
    ...
    component= 0xffff -
               (((color->red^
                  0xffff)*
                 unadjusted->red)>>FIXED_FRACTIONAL_BITS) - transparency,
    adjusted->red= CEILING(component, unadjusted->red);
    component= 0xffff -
               (((color->green^
                  0xffff)*
                 unadjusted->green)>>FIXED_FRACTIONAL_BITS) - transparency,
    adjusted->green= CEILING(component, unadjusted->green);
    component= 0xffff -
               (((color->blue^
                  0xffff)*
                 unadjusted->blue)>>FIXED_FRACTIONAL_BITS) - transparency,
  ...
  _fixed transparency)
{
  ...
  for (i= 0; i<original_color_table->color_count; ++i, ++adjusted, ++unadjusted)
  {
    ...
    component=
      ((color->red*unadjusted->red)>>FIXED_FRACTIONAL_BITS) + transparency,
    adjusted->red= CEILING(component, unadjusted->red);
    component=
      ((color->green*unadjusted->green)>>FIXED_FRACTIONAL_BITS) + transparency,
    adjusted->green= CEILING(component, unadjusted->green);
    component=
      ((color->blue*unadjusted->blue)>>FIXED_FRACTIONAL_BITS) + transparency,
    adjusted->blue= CEILING(component, unadjusted->blue);
  }
}
  ...
  _fixed transparency)
{
  ...
  for (i= 0; i<original_color_table->color_count; ++i, ++adjusted, ++unadjusted)
  {
    ...
    intensity=
      MAX(intensity, unadjusted->blue)>>ADJUSTED_TRANSPARENCY_DOWNSHIFT;

    adjusted->red= unadjusted->red +
                   (((((color->red*
                        intensity)>>
                       (FIXED_FRACTIONAL_BITS-
                        ADJUSTED_TRANSPARENCY_DOWNSHIFT))-
                      unadjusted->red)*
                     adjusted_transparency)>>
                    (FIXED_FRACTIONAL_BITS-ADJUSTED_TRANSPARENCY_DOWNSHIFT));
    adjusted->green= unadjusted->green +
...
bool XML_FaderParser::Start()
{
  ...
  if (!original_fade_definitions) {
    original_fade_definitions =
      (struct fade_definition *) malloc(
        sizeof(struct fade_definition) * NUMBER_OF_FADE_TYPES);
...
bool XML_FaderParser::HandleAttribute(const char *Tag, const char *Value)
{
  if (StringsEqual(Tag,"index")) {
    ...
    float Opacity;
    if (ReadBoundedNumericalValue(Value,"%f",Opacity,float(-SHRT_MAX),
                                  float(SHRT_MAX))) {
...
bool XML_FaderParser::AttributesDone()
{
  ...
  if (IsPresent[1]) {
    OrigData.initial_transparency = Data.initial_transparency;
  }
  if (IsPresent[2]) {
    OrigData.final_transparency = Data.final_transparency;
  }
  if (IsPresent[3]) {
    OrigData.period = Data.period;
  }
  if (IsPresent[4]) {
    OrigData.flags = Data.flags;
  }
  if (IsPresent[5]) {
    OrigData.priority = Data.priority;
  }
...
bool XML_LiquidFaderParser::Start()
{
  ...
  if (!original_fade_effect_definitions) {
    original_fade_effect_definitions = (struct fade_effect_definition *) malloc(
      sizeof(struct fade_effect_definition) * NUMBER_OF_FADE_EFFECT_TYPES);
...
bool XML_LiquidFaderParser::HandleAttribute(const char *Tag, const char *Value)
{
  if (StringsEqual(Tag,"index")) {
    ...
    if (ReadBoundedInt16Value(Value,Data.fade_type,NONE,NUMBER_OF_FADE_TYPES-
                              1)) {
      IsPresent[0] = true;
      return true;
    }
...
bool XML_LiquidFaderParser::AttributesDone()
{
  ...
  if (IsPresent[0]) {
    OrigData.fade_type = Data.fade_type;
  }
  if (IsPresent[1]) {
    OrigData.transparency = Data.transparency;
  }
