...
void draw_or_erase_unclipped_shape(short x, short y, shape_descriptor shape,
                                   bool draw);
...
void DrawShape(shape_descriptor shape, screen_rectangle *dest,
               screen_rectangle *src);
void DrawShapeAtXY(shape_descriptor shape, short x, short y,
                   bool transparency = false);
void DrawText(const char *text, screen_rectangle *dest, short flags,
              short font_id,
              short text_color);
void FillRect(screen_rectangle *r, short color_index);
void FrameRect(screen_rectangle *r, short color_index);

void DrawTexture(shape_descriptor texture, short texture_type, short x, short y,
                 int size);
