...
void _draw_screen_shape_centered(shape_descriptor shape,
...
static inline int draw_text(SDL_Surface *s, const char *text, size_t length,
                            int x, int y, uint32 pixel, const font_info *font,
                            uint16 style,
                            bool utf8 = false)
{
...
static inline int draw_text(SDL_Surface *s, const char *text, int x, int y,
                            uint32 pixel, const font_info *font, uint16 style,
                            bool utf8 = false)
{
  return font ? font->draw_text(s, text, strlen(text), x, y, pixel, style,
                                utf8) : 0;
}
...
static inline uint16 text_width(const char *text, const font_info *font,
                                uint16 style,
                                bool utf8 = false)
{
...
static inline uint16 text_width(const char *text, size_t length,
                                const font_info *font, uint16 style,
                                bool utf8 = false)
{
  return font ? font->text_width(text, length, style, utf8) : 0;
}

static inline int trunc_text(const char *text, int max_width,
...
extern void draw_polygon(SDL_Surface *s, const world_point2d *vertex_array,
                         int vertex_count,
                         uint32 pixel);
extern void draw_line(SDL_Surface *s, const world_point2d *v1,
                      const world_point2d *v2, uint32 pixel,
                      int pen_size);
