...
#undef SDL_PROC
    ...
    PFNGLGETPROGRAMSTRINGARBPROC glGetProgramstd::stringARB;
    PFNGLPROGRAMLOCALPARAMETER4FVARBPROC glProgramLocalParameter4fvARB;
    PFNGLDELETEPROGRAMSARBPROC glDeleteProgramsARB;
    PFNGLGENPROGRAMSARBPROC glGenProgramsARB;
    PFNGLBINDPROGRAMARBPROC glBindProgramARB;
    PFNGLPROGRAMSTRINGARBPROC glProgramstd::stringARB;
...
GL_CreateRenderer(SDL_Window * window, Uint32 flags)
{
    ...
    if (SDL_GL_ExtensionSupported("GL_ARB_fragment_program")) {
        ...
        data->glGetProgramstd::stringARB = (PFNGLGETPROGRAMSTRINGARBPROC)
            SDL_GL_GetProcAddress("glGetProgramstd::stringARB");
        ...
        data->glProgramstd::stringARB = (PFNGLPROGRAMSTRINGARBPROC)
            SDL_GL_GetProcAddress("glProgramstd::stringARB");
...
compile_shader(GL_RenderData * data, GLenum shader_type, const char *_code)
{
    ...
    data->glProgramstd::stringARB(shader_type, GL_PROGRAM_FORMAT_ASCII_ARB,
    ...
    if (data->glGetError() == GL_INVALID_OPERATION) {
        ...
        errstr = data->glGetstd::string(GL_PROGRAM_ERROR_STRING_ARB);
