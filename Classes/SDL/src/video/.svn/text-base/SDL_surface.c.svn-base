                   ...
                   Uint32 flags)
{
	...
	// KP: optimization - check if it's already in the desired format...
	// can't do this, because some code expects a unique surface...
//	if (surface->format->BitsPerPixel == format->BitsPerPixel && surface->format->Rmask == format->Rmask && surface->format->Gmask == format->Gmask && surface->format->Bmask == format->Bmask)
//	{
//		surface->refcount++;
//		return surface;
//	}
